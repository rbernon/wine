...
WINE_DEFAULT_DEBUG_CHANNEL(wglchoose);
...
static void choose_pixel_format( HDC hdc, struct filter attribs )
{
    ...
    ERR( "--- ChoosePixelFormat ---\n" );
    print_pixel_format( hdc, choose_fmt );
    ERR( "--- wglChoosePixelFormatARB ---\n" );
...
int main(int argc, char *argv[])
{
    ...
    ERR( "ChoosePixelFormat -> %u\n", fmt );
    SetPixelFormat( hdc, fmt, &desc );

    ctx = wglCreateContext( hdc );
    ERR( "wglCreateContext -> %p\n", ctx );
    ret = wglMakeCurrent( hdc, ctx );
    ERR( "wglMakeCurrent -> %u\n", ret );
    ...
    memset( &filter, 0xff, sizeof(filter) );
    filter.buf = 16;
    ERR("===== wglchoose buf=16 =====\n");
    choose_pixel_format( hdc, filter );
    filter.a = 0;
    ERR("===== wglchoose buf=16:a=0 =====\n");
    choose_pixel_format( hdc, filter );
    filter.r = 5;
    filter.g = 6;
    filter.b = 5;
    filter.a = 1;
    ERR("===== wglchoose buf=16:r=5:g=5:b=5:a=1 =====\n");
    choose_pixel_format( hdc, filter );
    filter.a = 0;
    ERR("===== wglchoose buf=16:r=5:g=6:b=5:a=0 =====\n");
    choose_pixel_format( hdc, filter );

    memset( &filter, 0xff, sizeof(filter) );
    filter.buf = 32;
    ERR("===== wglchoose buf=32 =====\n");
    choose_pixel_format( hdc, filter );
    filter.a = 0;
    ERR("===== wglchoose buf=32:a=0 =====\n");
    choose_pixel_format( hdc, filter );
    filter.a = -1;
    filter.d = 0;
    filter.s = 0;
    ERR("===== wglchoose buf=32:d=0:s=0 =====\n");
    choose_pixel_format( hdc, filter );
    filter.d = 1;
    ERR("===== wglchoose buf=32:d=1:s=0 =====\n");
    choose_pixel_format( hdc, filter );
    filter.d = 0;
    filter.s = 1;
    ERR("===== wglchoose buf=32:d=0:s=1 =====\n");
    choose_pixel_format( hdc, filter );
    filter.a = 1;
    filter.d = 1;
    ERR("===== wglchoose buf=32:a=1:d=1:s=1 =====\n");
    choose_pixel_format( hdc, filter );

    memset( &filter, 0xff, sizeof(filter) );
    filter.buf = 24;
    filter.a = 0;
    ERR("===== wglchoose buf=24:a=0 =====\n");
    choose_pixel_format( hdc, filter );

    memset( &filter, 0xff, sizeof(filter) );
    ERR("===== wglchoose pixel=rgba:win:double:opengl:buf=32 =====\n");
    ...
    choose_pixel_format( hdc, filter );
    filter.a = 0;
    ERR("===== wglchoose pixel=rgba:win:double:opengl:buf=32:a=0 =====\n");
    choose_pixel_format( hdc, filter );
    filter.a = -1;
    filter.d = 0;
    filter.s = 0;
    ERR("===== wglchoose pixel=rgba:win:double:opengl:buf=32:d=0:s=0 =====\n");
    choose_pixel_format( hdc, filter );
    filter.a = 1;
    filter.d = 1;
    filter.s = 1;
    ERR("===== wglchoose pixel=rgba:win:double:opengl:buf=32:a=1:d=1:s=1 =====\n");
    choose_pixel_format( hdc, filter );
    filter.buf = 16;
    filter.a = 0;
    filter.d = -1;
    filter.s = -1;
    ERR("===== wglchoose pixel=rgba:win:double:opengl:buf=16:a=0 =====\n");
    choose_pixel_format( hdc, filter );
    filter.r = 5;
    filter.g = 6;
    filter.b = 5;
    filter.a = 1;
    ERR("===== wglchoose pixel=rgba:win:double:opengl:buf=16:r=5:g=5:b=5:a=1 =====\n");
    choose_pixel_format( hdc, filter );
    filter.a = 0;
    ERR("===== wglchoose pixel=rgba:win:double:opengl:buf=16:r=5:g=6:b=5:a=0 =====\n");
    choose_pixel_format( hdc, filter );
    ...
    filter.g = 10;
    filter.b = 10;
    ERR("===== wglchoose buf=32:r=10:g=10:b=10 =====\n");
    choose_pixel_format( hdc, filter );
