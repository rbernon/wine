...
static BOOL be_arm64_is_func_call(struct dbg_thread* thread, const dbg_ctx_t* ctx, const void* insn, ADDRESS64* callee)
{
    return FALSE;
}

static BOOL be_arm64_is_jump(struct dbg_thread* thread, const dbg_ctx_t* ctx, const void* insn, ADDRESS64* jumpee)
{
    return FALSE;
}
...
static struct gdb_register be_arm64_gdb_register_map[] = {
    REG("core", "x0",   NULL,         NULL,    u.s.X0),
    REG(NULL,   "x1",   NULL,         NULL,    u.s.X1),
    REG(NULL,   "x2",   NULL,         NULL,    u.s.X2),
    REG(NULL,   "x3",   NULL,         NULL,    u.s.X3),
    REG(NULL,   "x4",   NULL,         NULL,    u.s.X4),
    REG(NULL,   "x5",   NULL,         NULL,    u.s.X5),
    REG(NULL,   "x6",   NULL,         NULL,    u.s.X6),
    REG(NULL,   "x7",   NULL,         NULL,    u.s.X7),
    REG(NULL,   "x8",   NULL,         NULL,    u.s.X8),
    REG(NULL,   "x9",   NULL,         NULL,    u.s.X9),
    REG(NULL,   "x10",  NULL,         NULL,    u.s.X10),
    REG(NULL,   "x11",  NULL,         NULL,    u.s.X11),
    REG(NULL,   "x12",  NULL,         NULL,    u.s.X12),
    REG(NULL,   "x13",  NULL,         NULL,    u.s.X13),
    REG(NULL,   "x14",  NULL,         NULL,    u.s.X14),
    REG(NULL,   "x15",  NULL,         NULL,    u.s.X15),
    REG(NULL,   "x16",  NULL,         NULL,    u.s.X16),
    REG(NULL,   "x17",  NULL,         NULL,    u.s.X17),
    REG(NULL,   "x18",  NULL,         NULL,    u.s.X18),
    REG(NULL,   "x19",  NULL,         NULL,    u.s.X19),
    REG(NULL,   "x20",  NULL,         NULL,    u.s.X20),
    REG(NULL,   "x21",  NULL,         NULL,    u.s.X21),
    REG(NULL,   "x22",  NULL,         NULL,    u.s.X22),
    REG(NULL,   "x23",  NULL,         NULL,    u.s.X23),
    REG(NULL,   "x24",  NULL,         NULL,    u.s.X24),
    REG(NULL,   "x25",  NULL,         NULL,    u.s.X25),
    REG(NULL,   "x26",  NULL,         NULL,    u.s.X26),
    REG(NULL,   "x27",  NULL,         NULL,    u.s.X27),
    REG(NULL,   "x28",  NULL,         NULL,    u.s.X28),
    REG(NULL,   "x29",  NULL,         NULL,    u.s.Fp),
    REG(NULL,   "x30",  NULL,         NULL,    u.s.Lr),
    REG(NULL,   "sp",   "data_ptr",   "sp",    Sp),
    REG(NULL,   "pc",   "code_ptr",   "pc",    Pc),
    REG(NULL,   "cpsr", "cpsr_flags", "flags", Cpsr),
};
