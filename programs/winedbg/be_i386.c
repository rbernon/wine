...
#define REG(f,n,t,g,r)  {f, n, t, g, FIELD_OFFSET(WOW64_CONTEXT, r), sizeof(((WOW64_CONTEXT*)NULL)->r)}

static struct gdb_register be_i386_gdb_register_map[] = {
    REG("core", "eax",    NULL,          NULL,    Eax),
    REG(NULL,   "ecx",    NULL,          NULL,    Ecx),
    REG(NULL,   "edx",    NULL,          NULL,    Edx),
    REG(NULL,   "ebx",    NULL,          NULL,    Ebx),
    REG(NULL,   "esp",    "data_ptr",    "sp",    Esp),
    REG(NULL,   "ebp",    "data_ptr",    "fp",    Ebp),
    REG(NULL,   "esi",    NULL,          NULL,    Esi),
    REG(NULL,   "edi",    NULL,          NULL,    Edi),
    REG(NULL,   "eip",    "code_ptr",    "pc",    Eip),
    REG(NULL,   "eflags", "i386_eflags", "flags", EFlags),
    REG(NULL,   "cs",     NULL,          NULL,    SegCs),
    REG(NULL,   "ss",     NULL,          NULL,    SegSs),
    REG(NULL,   "ds",     NULL,          NULL,    SegDs),
    REG(NULL,   "es",     NULL,          NULL,    SegEs),
    REG(NULL,   "fs",     NULL,          NULL,    SegFs),
    REG(NULL,   "gs",     NULL,          NULL,    SegGs),
    { NULL,     "st0",    "i387_ext",    NULL,    FIELD_OFFSET(WOW64_CONTEXT, FloatSave.RegisterArea[ 0]), 10},
    { NULL,     "st1",    "i387_ext",    NULL,    FIELD_OFFSET(WOW64_CONTEXT, FloatSave.RegisterArea[10]), 10},
    { NULL,     "st2",    "i387_ext",    NULL,    FIELD_OFFSET(WOW64_CONTEXT, FloatSave.RegisterArea[20]), 10},
    { NULL,     "st3",    "i387_ext",    NULL,    FIELD_OFFSET(WOW64_CONTEXT, FloatSave.RegisterArea[30]), 10},
    { NULL,     "st4",    "i387_ext",    NULL,    FIELD_OFFSET(WOW64_CONTEXT, FloatSave.RegisterArea[40]), 10},
    { NULL,     "st5",    "i387_ext",    NULL,    FIELD_OFFSET(WOW64_CONTEXT, FloatSave.RegisterArea[50]), 10},
    { NULL,     "st6",    "i387_ext",    NULL,    FIELD_OFFSET(WOW64_CONTEXT, FloatSave.RegisterArea[60]), 10},
    { NULL,     "st7",    "i387_ext",    NULL,    FIELD_OFFSET(WOW64_CONTEXT, FloatSave.RegisterArea[70]), 10},
    { NULL,     "fctrl",  NULL,          NULL,    FIELD_OFFSET(WOW64_CONTEXT, FloatSave.ControlWord), 2},
    { NULL,     "fstat",  NULL,          NULL,    FIELD_OFFSET(WOW64_CONTEXT, FloatSave.StatusWord), 2},
    { NULL,     "ftag",   NULL,          NULL,    FIELD_OFFSET(WOW64_CONTEXT, FloatSave.TagWord), 2},
    { NULL,     "fiseg",  NULL,          NULL,    FIELD_OFFSET(WOW64_CONTEXT, FloatSave.ErrorSelector), 2},
    REG(NULL,   "fioff",  NULL,          NULL,    FloatSave.ErrorOffset),
    { NULL,     "foseg",  NULL,          NULL,    FIELD_OFFSET(WOW64_CONTEXT, FloatSave.DataSelector), 2},
    REG(NULL,   "fooff",  NULL,          NULL,    FloatSave.DataOffset),
    { NULL,     "fop",    NULL,          NULL,    FIELD_OFFSET(WOW64_CONTEXT, FloatSave.ErrorSelector)+2, 2},

    { "sse", "xmm0",  "vec128",     NULL, FIELD_OFFSET(WOW64_CONTEXT, ExtendedRegisters) + FIELD_OFFSET(XSAVE_FORMAT, XmmRegisters[0]), 16},
    { NULL,  "xmm1",  "vec128",     NULL, FIELD_OFFSET(WOW64_CONTEXT, ExtendedRegisters) + FIELD_OFFSET(XSAVE_FORMAT, XmmRegisters[1]), 16},
    { NULL,  "xmm2",  "vec128",     NULL, FIELD_OFFSET(WOW64_CONTEXT, ExtendedRegisters) + FIELD_OFFSET(XSAVE_FORMAT, XmmRegisters[2]), 16},
    { NULL,  "xmm3",  "vec128",     NULL, FIELD_OFFSET(WOW64_CONTEXT, ExtendedRegisters) + FIELD_OFFSET(XSAVE_FORMAT, XmmRegisters[3]), 16},
    { NULL,  "xmm4",  "vec128",     NULL, FIELD_OFFSET(WOW64_CONTEXT, ExtendedRegisters) + FIELD_OFFSET(XSAVE_FORMAT, XmmRegisters[4]), 16},
    { NULL,  "xmm5",  "vec128",     NULL, FIELD_OFFSET(WOW64_CONTEXT, ExtendedRegisters) + FIELD_OFFSET(XSAVE_FORMAT, XmmRegisters[5]), 16},
    { NULL,  "xmm6",  "vec128",     NULL, FIELD_OFFSET(WOW64_CONTEXT, ExtendedRegisters) + FIELD_OFFSET(XSAVE_FORMAT, XmmRegisters[6]), 16},
    { NULL,  "xmm7",  "vec128",     NULL, FIELD_OFFSET(WOW64_CONTEXT, ExtendedRegisters) + FIELD_OFFSET(XSAVE_FORMAT, XmmRegisters[7]), 16},
    { NULL,  "mxcsr", "i386_mxcsr", NULL, FIELD_OFFSET(WOW64_CONTEXT, ExtendedRegisters) + FIELD_OFFSET(XSAVE_FORMAT, MxCsr), 4},
};
