...
static struct gdb_register be_arm_gdb_register_map[] = {
    REG("core", "r0",   NULL,       NULL,    R0),
    REG(NULL,   "r1",   NULL,       NULL,    R1),
    REG(NULL,   "r2",   NULL,       NULL,    R2),
    REG(NULL,   "r3",   NULL,       NULL,    R3),
    REG(NULL,   "r4",   NULL,       NULL,    R4),
    REG(NULL,   "r5",   NULL,       NULL,    R5),
    REG(NULL,   "r6",   NULL,       NULL,    R6),
    REG(NULL,   "r7",   NULL,       NULL,    R7),
    ...
    REG(NULL,   "lr",   "code_ptr", "ar",    Lr),
    REG(NULL,   "pc",   "code_ptr", "pc",    Pc),
    REG(NULL,   "cpsr", NULL,       "flags", Cpsr),
};
