...
#define REG(f,n,t,g,r)  {f, n, t, g, FIELD_OFFSET(CONTEXT, r), sizeof(((CONTEXT*)NULL)->r)}

static struct gdb_register be_x86_64_gdb_register_map[] = {
    REG("core", "rax",    NULL,          NULL,    Rax),
    REG(NULL,   "rbx",    NULL,          NULL,    Rbx),
    REG(NULL,   "rcx",    NULL,          NULL,    Rcx),
    REG(NULL,   "rdx",    NULL,          NULL,    Rdx),
    REG(NULL,   "rsi",    NULL,          NULL,    Rsi),
    REG(NULL,   "rdi",    NULL,          NULL,    Rdi),
    REG(NULL,   "rbp",    "data_ptr",    "fp",    Rbp),
    REG(NULL,   "rsp",    "data_ptr",    "sp",    Rsp),
    REG(NULL,   "r8",     NULL,          NULL,    R8),
    REG(NULL,   "r9",     NULL,          NULL,    R9),
    REG(NULL,   "r10",    NULL,          NULL,    R10),
    REG(NULL,   "r11",    NULL,          NULL,    R11),
    REG(NULL,   "r12",    NULL,          NULL,    R12),
    REG(NULL,   "r13",    NULL,          NULL,    R13),
    REG(NULL,   "r14",    NULL,          NULL,    R14),
    REG(NULL,   "r15",    NULL,          NULL,    R15),
    REG(NULL,   "rip",    "code_ptr",    "pc",    Rip),
    ...
    { NULL,     "st0",    "i387_ext",    NULL,    FIELD_OFFSET(CONTEXT, u.FltSave.FloatRegisters[ 0]), 10},
    { NULL,     "st1",    "i387_ext",    NULL,    FIELD_OFFSET(CONTEXT, u.FltSave.FloatRegisters[ 1]), 10},
    { NULL,     "st2",    "i387_ext",    NULL,    FIELD_OFFSET(CONTEXT, u.FltSave.FloatRegisters[ 2]), 10},
    { NULL,     "st3",    "i387_ext",    NULL,    FIELD_OFFSET(CONTEXT, u.FltSave.FloatRegisters[ 3]), 10},
    { NULL,     "st4",    "i387_ext",    NULL,    FIELD_OFFSET(CONTEXT, u.FltSave.FloatRegisters[ 4]), 10},
    { NULL,     "st5",    "i387_ext",    NULL,    FIELD_OFFSET(CONTEXT, u.FltSave.FloatRegisters[ 5]), 10},
    { NULL,     "st6",    "i387_ext",    NULL,    FIELD_OFFSET(CONTEXT, u.FltSave.FloatRegisters[ 6]), 10},
    { NULL,     "st7",    "i387_ext",    NULL,    FIELD_OFFSET(CONTEXT, u.FltSave.FloatRegisters[ 7]), 10},
    REG(NULL,   "fctrl",  NULL,          NULL,    u.FltSave.ControlWord),
    REG(NULL,   "fstat",  NULL,          NULL,    u.FltSave.StatusWord),
    REG(NULL,   "ftag",   NULL,          NULL,    u.FltSave.TagWord),
    REG(NULL,   "fiseg",  NULL,          NULL,    u.FltSave.ErrorSelector),
    REG(NULL,   "fioff",  NULL,          NULL,    u.FltSave.ErrorOffset),
    REG(NULL,   "foseg",  NULL,          NULL,    u.FltSave.DataSelector),
    REG(NULL,   "fooff",  NULL,          NULL,    u.FltSave.DataOffset),
    REG(NULL,   "fop",    NULL,          NULL,    u.FltSave.ErrorOpcode),

    REG("sse", "xmm0",  "vec128",     NULL, u.s.Xmm0),
    REG(NULL,  "xmm1",  "vec128",     NULL, u.s.Xmm1),
    REG(NULL,  "xmm2",  "vec128",     NULL, u.s.Xmm2),
    REG(NULL,  "xmm3",  "vec128",     NULL, u.s.Xmm3),
    REG(NULL,  "xmm4",  "vec128",     NULL, u.s.Xmm4),
    REG(NULL,  "xmm5",  "vec128",     NULL, u.s.Xmm5),
    REG(NULL,  "xmm6",  "vec128",     NULL, u.s.Xmm6),
    REG(NULL,  "xmm7",  "vec128",     NULL, u.s.Xmm7),
    REG(NULL,  "xmm8",  "vec128",     NULL, u.s.Xmm8),
    REG(NULL,  "xmm9",  "vec128",     NULL, u.s.Xmm9),
    REG(NULL,  "xmm10", "vec128",     NULL, u.s.Xmm10),
    REG(NULL,  "xmm11", "vec128",     NULL, u.s.Xmm11),
    REG(NULL,  "xmm12", "vec128",     NULL, u.s.Xmm12),
    REG(NULL,  "xmm13", "vec128",     NULL, u.s.Xmm13),
    REG(NULL,  "xmm14", "vec128",     NULL, u.s.Xmm14),
    REG(NULL,  "xmm15", "vec128",     NULL, u.s.Xmm15),
    REG(NULL,  "mxcsr", "i386_mxcsr", NULL, u.FltSave.MxCsr),
};
