...
static NTSTATUS x11drv_wow64_init( void *arg )
{
    ...
    params.dnd_enter_event_callback = params32->dnd_enter_event_callback;
    params.dnd_position_event_callback = params32->dnd_position_event_callback;
    params.dnd_post_drop_callback = params32->dnd_post_drop_callback;
    params.dnd_drop_event_callback = params32->dnd_drop_event_callback;
    params.dnd_leave_event_callback = params32->dnd_leave_event_callback;
