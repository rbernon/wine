...
extern struct dnd_enter_event_params *import_xdnd_selection( Display *display, Window win, Atom selection,
...
extern struct dnd_post_drop_params *file_list_to_drop_files( const void *data, size_t size, size_t *ret_size );
extern struct dnd_post_drop_params *uri_list_to_drop_files( const void *data, size_t size, size_t *ret_size );
