                                             ...
                                             const VkAllocationCallbacks *allocator, VkSwapchainKHR *ret )
{
    ...
    if ((res = device->host_vkCreateSwapchainKHR( device->host.device, &create_info_host, NULL, &host_swapchain )))
    {
        free( swapchain );
        return res;
    }
                                   ...
                                   const VkAllocationCallbacks *allocator )
{
    ...
    device->host_vkDestroySwapchainKHR( device->host.device, swapchain->obj.host.swapchain, NULL );
