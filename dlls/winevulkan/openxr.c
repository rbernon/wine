...
XrResult WINAPI xrCreateApiLayerInstance(const XrInstanceCreateInfo *info, const XrApiLayerCreateInfo *layer_info, XrInstance *instance)
{
    ERR("Unexpected call\n");
    return XR_ERROR_FUNCTION_UNSUPPORTED;
}
...
XrResult WINAPI xrNegotiateLoaderApiLayerInterface(const XrNegotiateLoaderInfo *loader_info, const char *layer_name, XrNegotiateApiLayerRequest *request)
{
    ERR("Unexpected call\n");
    return XR_ERROR_FUNCTION_UNSUPPORTED;
}
...
XrResult WINAPI xrCreateVulkanDeviceKHR(XrInstance instance, const XrVulkanDeviceCreateInfoKHR *create_info, VkDevice *vulkan_device, VkResult *vulkan_result)
{
...
XrResult WINAPI xrCreateVulkanInstanceKHR(XrInstance instance, const XrVulkanInstanceCreateInfoKHR *create_info, VkInstance *vulkan_instance, VkResult *vulkan_result)
{
...
XrResult WINAPI xrGetD3D11GraphicsRequirementsKHR(XrInstance instance, XrSystemId system_id, XrGraphicsRequirementsD3D11KHR *requirements)
{
...
XrResult WINAPI xrGetD3D12GraphicsRequirementsKHR(XrInstance instance, XrSystemId system_id, XrGraphicsRequirementsD3D12KHR *requirements)
{
...
XrResult WINAPI xrGetVulkanDeviceExtensionsKHR(XrInstance instance, XrSystemId system_id, uint32_t capacity, uint32_t *count, char *buffer)
{
...
XrResult WINAPI xrGetVulkanGraphicsDevice2KHR(XrInstance instance, const XrVulkanGraphicsDeviceGetInfoKHR *get_info, VkPhysicalDevice *vulkan_physical_device)
{
...
XrResult WINAPI xrGetVulkanGraphicsDeviceKHR(XrInstance instance, XrSystemId system_id, VkInstance vulkan_instance, VkPhysicalDevice *vulkan_physical_device)
{
...
XrResult WINAPI xrGetVulkanInstanceExtensionsKHR(XrInstance instance, XrSystemId system_id, uint32_t capacity, uint32_t *count, char *buffer)
{
...
XrResult WINAPI xrAcquireSwapchainImage(XrSwapchain swapchain, const XrSwapchainImageAcquireInfo *acquire_info, uint32_t *index)
{
...
XrResult WINAPI xrEnumerateSwapchainImages(XrSwapchain swapchain, uint32_t capacity, uint32_t *count, XrSwapchainImageBaseHeader *images)
{
...
XrResult WINAPI xrCreateAction(XrActionSet actionSet, const XrActionCreateInfo *create_info, XrAction *action)
{
