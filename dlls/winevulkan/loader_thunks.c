...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdBindDescriptorSets2KHR == 37 );
VK_FAST_THUNK( vkCmdBindDescriptorSets2KHR, "37", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 4
C_ASSERT( unix_vkCmdBindIndexBuffer == 38 );
VK_FAST_THUNK( vkCmdBindIndexBuffer, "38", 4 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 5
C_ASSERT( unix_vkCmdBindIndexBuffer2KHR == 39 );
VK_FAST_THUNK( vkCmdBindIndexBuffer2KHR, "39", 5 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 3
C_ASSERT( unix_vkCmdBindInvocationMaskHUAWEI == 40 );
VK_FAST_THUNK( vkCmdBindInvocationMaskHUAWEI, "40", 3 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 3
C_ASSERT( unix_vkCmdBindPipeline == 41 );
VK_FAST_THUNK( vkCmdBindPipeline, "41", 3 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 4
C_ASSERT( unix_vkCmdBindPipelineShaderGroupNV == 42 );
VK_FAST_THUNK( vkCmdBindPipelineShaderGroupNV, "42", 4 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 4
C_ASSERT( unix_vkCmdBindShadersEXT == 43 );
VK_FAST_THUNK( vkCmdBindShadersEXT, "43", 4 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 3
C_ASSERT( unix_vkCmdBindShadingRateImageNV == 44 );
VK_FAST_THUNK( vkCmdBindShadingRateImageNV, "44", 3 )
#else
...
C_ASSERT( unix_vkCmdBindTransformFeedbackBuffersEXT == 45 );
VK_FAST_THUNK( vkCmdBindTransformFeedbackBuffersEXT, "45", 6 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 5
C_ASSERT( unix_vkCmdBindVertexBuffers == 46 );
VK_FAST_THUNK( vkCmdBindVertexBuffers, "46", 5 )
#else
...
C_ASSERT( unix_vkCmdBindVertexBuffers2 == 47 );
VK_FAST_THUNK( vkCmdBindVertexBuffers2, "47", 7 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 7
C_ASSERT( unix_vkCmdBindVertexBuffers2EXT == 48 );
VK_FAST_THUNK( vkCmdBindVertexBuffers2EXT, "48", 7 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 8
C_ASSERT( unix_vkCmdBlitImage == 49 );
VK_FAST_THUNK( vkCmdBlitImage, "49", 8 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdBlitImage2 == 50 );
VK_FAST_THUNK( vkCmdBlitImage2, "50", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdBlitImage2KHR == 51 );
VK_FAST_THUNK( vkCmdBlitImage2KHR, "51", 2 )
#else
...
C_ASSERT( unix_vkCmdBuildAccelerationStructureNV == 52 );
VK_FAST_THUNK( vkCmdBuildAccelerationStructureNV, "52", 9 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 6
C_ASSERT( unix_vkCmdBuildAccelerationStructuresIndirectKHR == 53 );
VK_FAST_THUNK( vkCmdBuildAccelerationStructuresIndirectKHR, "53", 6 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 4
C_ASSERT( unix_vkCmdBuildAccelerationStructuresKHR == 54 );
VK_FAST_THUNK( vkCmdBuildAccelerationStructuresKHR, "54", 4 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 3
C_ASSERT( unix_vkCmdBuildMicromapsEXT == 55 );
VK_FAST_THUNK( vkCmdBuildMicromapsEXT, "55", 3 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 5
C_ASSERT( unix_vkCmdClearAttachments == 56 );
VK_FAST_THUNK( vkCmdClearAttachments, "56", 5 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 6
C_ASSERT( unix_vkCmdClearColorImage == 57 );
VK_FAST_THUNK( vkCmdClearColorImage, "57", 6 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 6
C_ASSERT( unix_vkCmdClearDepthStencilImage == 58 );
VK_FAST_THUNK( vkCmdClearDepthStencilImage, "58", 6 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdControlVideoCodingKHR == 59 );
VK_FAST_THUNK( vkCmdControlVideoCodingKHR, "59", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdCopyAccelerationStructureKHR == 60 );
VK_FAST_THUNK( vkCmdCopyAccelerationStructureKHR, "60", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 4
C_ASSERT( unix_vkCmdCopyAccelerationStructureNV == 61 );
VK_FAST_THUNK( vkCmdCopyAccelerationStructureNV, "61", 4 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdCopyAccelerationStructureToMemoryKHR == 62 );
VK_FAST_THUNK( vkCmdCopyAccelerationStructureToMemoryKHR, "62", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 5
C_ASSERT( unix_vkCmdCopyBuffer == 63 );
VK_FAST_THUNK( vkCmdCopyBuffer, "63", 5 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdCopyBuffer2 == 64 );
VK_FAST_THUNK( vkCmdCopyBuffer2, "64", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdCopyBuffer2KHR == 65 );
VK_FAST_THUNK( vkCmdCopyBuffer2KHR, "65", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 6
C_ASSERT( unix_vkCmdCopyBufferToImage == 66 );
VK_FAST_THUNK( vkCmdCopyBufferToImage, "66", 6 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdCopyBufferToImage2 == 67 );
VK_FAST_THUNK( vkCmdCopyBufferToImage2, "67", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdCopyBufferToImage2KHR == 68 );
VK_FAST_THUNK( vkCmdCopyBufferToImage2KHR, "68", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 7
C_ASSERT( unix_vkCmdCopyImage == 69 );
VK_FAST_THUNK( vkCmdCopyImage, "69", 7 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdCopyImage2 == 70 );
VK_FAST_THUNK( vkCmdCopyImage2, "70", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdCopyImage2KHR == 71 );
VK_FAST_THUNK( vkCmdCopyImage2KHR, "71", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 6
C_ASSERT( unix_vkCmdCopyImageToBuffer == 72 );
VK_FAST_THUNK( vkCmdCopyImageToBuffer, "72", 6 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdCopyImageToBuffer2 == 73 );
VK_FAST_THUNK( vkCmdCopyImageToBuffer2, "73", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdCopyImageToBuffer2KHR == 74 );
VK_FAST_THUNK( vkCmdCopyImageToBuffer2KHR, "74", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 4
C_ASSERT( unix_vkCmdCopyMemoryIndirectNV == 75 );
VK_FAST_THUNK( vkCmdCopyMemoryIndirectNV, "75", 4 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdCopyMemoryToAccelerationStructureKHR == 76 );
VK_FAST_THUNK( vkCmdCopyMemoryToAccelerationStructureKHR, "76", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 7
C_ASSERT( unix_vkCmdCopyMemoryToImageIndirectNV == 77 );
VK_FAST_THUNK( vkCmdCopyMemoryToImageIndirectNV, "77", 7 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdCopyMemoryToMicromapEXT == 78 );
VK_FAST_THUNK( vkCmdCopyMemoryToMicromapEXT, "78", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdCopyMicromapEXT == 79 );
VK_FAST_THUNK( vkCmdCopyMicromapEXT, "79", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdCopyMicromapToMemoryEXT == 80 );
VK_FAST_THUNK( vkCmdCopyMicromapToMemoryEXT, "80", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 8
C_ASSERT( unix_vkCmdCopyQueryPoolResults == 81 );
VK_FAST_THUNK( vkCmdCopyQueryPoolResults, "81", 8 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdCuLaunchKernelNVX == 82 );
VK_FAST_THUNK( vkCmdCuLaunchKernelNVX, "82", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdCudaLaunchKernelNV == 83 );
VK_FAST_THUNK( vkCmdCudaLaunchKernelNV, "83", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdDebugMarkerBeginEXT == 84 );
VK_FAST_THUNK( vkCmdDebugMarkerBeginEXT, "84", 2 )
#else
...
C_ASSERT( unix_vkCmdDebugMarkerEndEXT == 85 );
VK_FAST_THUNK( vkCmdDebugMarkerEndEXT, "85", 1 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdDebugMarkerInsertEXT == 86 );
VK_FAST_THUNK( vkCmdDebugMarkerInsertEXT, "86", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdDecodeVideoKHR == 87 );
VK_FAST_THUNK( vkCmdDecodeVideoKHR, "87", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 4
C_ASSERT( unix_vkCmdDecompressMemoryIndirectCountNV == 88 );
VK_FAST_THUNK( vkCmdDecompressMemoryIndirectCountNV, "88", 4 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 3
C_ASSERT( unix_vkCmdDecompressMemoryNV == 89 );
VK_FAST_THUNK( vkCmdDecompressMemoryNV, "89", 3 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 4
C_ASSERT( unix_vkCmdDispatch == 90 );
VK_FAST_THUNK( vkCmdDispatch, "90", 4 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 7
C_ASSERT( unix_vkCmdDispatchBase == 91 );
VK_FAST_THUNK( vkCmdDispatchBase, "91", 7 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 7
C_ASSERT( unix_vkCmdDispatchBaseKHR == 92 );
VK_FAST_THUNK( vkCmdDispatchBaseKHR, "92", 7 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 3
C_ASSERT( unix_vkCmdDispatchIndirect == 93 );
VK_FAST_THUNK( vkCmdDispatchIndirect, "93", 3 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 5
C_ASSERT( unix_vkCmdDraw == 94 );
VK_FAST_THUNK( vkCmdDraw, "94", 5 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 4
C_ASSERT( unix_vkCmdDrawClusterHUAWEI == 95 );
VK_FAST_THUNK( vkCmdDrawClusterHUAWEI, "95", 4 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 3
C_ASSERT( unix_vkCmdDrawClusterIndirectHUAWEI == 96 );
VK_FAST_THUNK( vkCmdDrawClusterIndirectHUAWEI, "96", 3 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 6
C_ASSERT( unix_vkCmdDrawIndexed == 97 );
VK_FAST_THUNK( vkCmdDrawIndexed, "97", 6 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 5
C_ASSERT( unix_vkCmdDrawIndexedIndirect == 98 );
VK_FAST_THUNK( vkCmdDrawIndexedIndirect, "98", 5 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 7
C_ASSERT( unix_vkCmdDrawIndexedIndirectCount == 99 );
VK_FAST_THUNK( vkCmdDrawIndexedIndirectCount, "99", 7 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 7
C_ASSERT( unix_vkCmdDrawIndexedIndirectCountAMD == 100 );
VK_FAST_THUNK( vkCmdDrawIndexedIndirectCountAMD, "100", 7 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 7
C_ASSERT( unix_vkCmdDrawIndexedIndirectCountKHR == 101 );
VK_FAST_THUNK( vkCmdDrawIndexedIndirectCountKHR, "101", 7 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 5
C_ASSERT( unix_vkCmdDrawIndirect == 102 );
VK_FAST_THUNK( vkCmdDrawIndirect, "102", 5 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 7
C_ASSERT( unix_vkCmdDrawIndirectByteCountEXT == 103 );
VK_FAST_THUNK( vkCmdDrawIndirectByteCountEXT, "103", 7 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 7
C_ASSERT( unix_vkCmdDrawIndirectCount == 104 );
VK_FAST_THUNK( vkCmdDrawIndirectCount, "104", 7 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 7
C_ASSERT( unix_vkCmdDrawIndirectCountAMD == 105 );
VK_FAST_THUNK( vkCmdDrawIndirectCountAMD, "105", 7 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 7
C_ASSERT( unix_vkCmdDrawIndirectCountKHR == 106 );
VK_FAST_THUNK( vkCmdDrawIndirectCountKHR, "106", 7 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 4
C_ASSERT( unix_vkCmdDrawMeshTasksEXT == 107 );
VK_FAST_THUNK( vkCmdDrawMeshTasksEXT, "107", 4 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 7
C_ASSERT( unix_vkCmdDrawMeshTasksIndirectCountEXT == 108 );
VK_FAST_THUNK( vkCmdDrawMeshTasksIndirectCountEXT, "108", 7 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 7
C_ASSERT( unix_vkCmdDrawMeshTasksIndirectCountNV == 109 );
VK_FAST_THUNK( vkCmdDrawMeshTasksIndirectCountNV, "109", 7 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 5
C_ASSERT( unix_vkCmdDrawMeshTasksIndirectEXT == 110 );
VK_FAST_THUNK( vkCmdDrawMeshTasksIndirectEXT, "110", 5 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 5
C_ASSERT( unix_vkCmdDrawMeshTasksIndirectNV == 111 );
VK_FAST_THUNK( vkCmdDrawMeshTasksIndirectNV, "111", 5 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 3
C_ASSERT( unix_vkCmdDrawMeshTasksNV == 112 );
VK_FAST_THUNK( vkCmdDrawMeshTasksNV, "112", 3 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 6
C_ASSERT( unix_vkCmdDrawMultiEXT == 113 );
VK_FAST_THUNK( vkCmdDrawMultiEXT, "113", 6 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 7
C_ASSERT( unix_vkCmdDrawMultiIndexedEXT == 114 );
VK_FAST_THUNK( vkCmdDrawMultiIndexedEXT, "114", 7 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdEncodeVideoKHR == 115 );
VK_FAST_THUNK( vkCmdEncodeVideoKHR, "115", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 1
C_ASSERT( unix_vkCmdEndConditionalRenderingEXT == 116 );
VK_FAST_THUNK( vkCmdEndConditionalRenderingEXT, "116", 1 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 1
C_ASSERT( unix_vkCmdEndDebugUtilsLabelEXT == 117 );
VK_FAST_THUNK( vkCmdEndDebugUtilsLabelEXT, "117", 1 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 3
C_ASSERT( unix_vkCmdEndQuery == 118 );
VK_FAST_THUNK( vkCmdEndQuery, "118", 3 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 4
C_ASSERT( unix_vkCmdEndQueryIndexedEXT == 119 );
VK_FAST_THUNK( vkCmdEndQueryIndexedEXT, "119", 4 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 1
C_ASSERT( unix_vkCmdEndRenderPass == 120 );
VK_FAST_THUNK( vkCmdEndRenderPass, "120", 1 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdEndRenderPass2 == 121 );
VK_FAST_THUNK( vkCmdEndRenderPass2, "121", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdEndRenderPass2KHR == 122 );
VK_FAST_THUNK( vkCmdEndRenderPass2KHR, "122", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 1
C_ASSERT( unix_vkCmdEndRendering == 123 );
VK_FAST_THUNK( vkCmdEndRendering, "123", 1 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 1
C_ASSERT( unix_vkCmdEndRenderingKHR == 124 );
VK_FAST_THUNK( vkCmdEndRenderingKHR, "124", 1 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 5
C_ASSERT( unix_vkCmdEndTransformFeedbackEXT == 125 );
VK_FAST_THUNK( vkCmdEndTransformFeedbackEXT, "125", 5 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdEndVideoCodingKHR == 126 );
VK_FAST_THUNK( vkCmdEndVideoCodingKHR, "126", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 3
C_ASSERT( unix_vkCmdExecuteCommands == 127 );
VK_FAST_THUNK( vkCmdExecuteCommands, "127", 3 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 3
C_ASSERT( unix_vkCmdExecuteGeneratedCommandsEXT == 128 );
VK_FAST_THUNK( vkCmdExecuteGeneratedCommandsEXT, "128", 3 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 3
C_ASSERT( unix_vkCmdExecuteGeneratedCommandsNV == 129 );
VK_FAST_THUNK( vkCmdExecuteGeneratedCommandsNV, "129", 3 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 5
C_ASSERT( unix_vkCmdFillBuffer == 130 );
VK_FAST_THUNK( vkCmdFillBuffer, "130", 5 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdInsertDebugUtilsLabelEXT == 131 );
VK_FAST_THUNK( vkCmdInsertDebugUtilsLabelEXT, "131", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdNextSubpass == 132 );
VK_FAST_THUNK( vkCmdNextSubpass, "132", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 3
C_ASSERT( unix_vkCmdNextSubpass2 == 133 );
VK_FAST_THUNK( vkCmdNextSubpass2, "133", 3 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 3
C_ASSERT( unix_vkCmdNextSubpass2KHR == 134 );
VK_FAST_THUNK( vkCmdNextSubpass2KHR, "134", 3 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 3
C_ASSERT( unix_vkCmdOpticalFlowExecuteNV == 135 );
VK_FAST_THUNK( vkCmdOpticalFlowExecuteNV, "135", 3 )
#else
...
C_ASSERT( unix_vkCmdPipelineBarrier == 136 );
VK_FAST_THUNK( vkCmdPipelineBarrier, "136", 10 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdPipelineBarrier2 == 137 );
VK_FAST_THUNK( vkCmdPipelineBarrier2, "137", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdPipelineBarrier2KHR == 138 );
VK_FAST_THUNK( vkCmdPipelineBarrier2KHR, "138", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 3
C_ASSERT( unix_vkCmdPreprocessGeneratedCommandsEXT == 139 );
VK_FAST_THUNK( vkCmdPreprocessGeneratedCommandsEXT, "139", 3 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdPreprocessGeneratedCommandsNV == 140 );
VK_FAST_THUNK( vkCmdPreprocessGeneratedCommandsNV, "140", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 6
C_ASSERT( unix_vkCmdPushConstants == 141 );
VK_FAST_THUNK( vkCmdPushConstants, "141", 6 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdPushConstants2KHR == 142 );
VK_FAST_THUNK( vkCmdPushConstants2KHR, "142", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdPushDescriptorSet2KHR == 143 );
VK_FAST_THUNK( vkCmdPushDescriptorSet2KHR, "143", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 6
C_ASSERT( unix_vkCmdPushDescriptorSetKHR == 144 );
VK_FAST_THUNK( vkCmdPushDescriptorSetKHR, "144", 6 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdPushDescriptorSetWithTemplate2KHR == 145 );
VK_FAST_THUNK( vkCmdPushDescriptorSetWithTemplate2KHR, "145", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 5
C_ASSERT( unix_vkCmdPushDescriptorSetWithTemplateKHR == 146 );
VK_FAST_THUNK( vkCmdPushDescriptorSetWithTemplateKHR, "146", 5 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 3
C_ASSERT( unix_vkCmdResetEvent == 147 );
VK_FAST_THUNK( vkCmdResetEvent, "147", 3 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 3
C_ASSERT( unix_vkCmdResetEvent2 == 148 );
VK_FAST_THUNK( vkCmdResetEvent2, "148", 3 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 3
C_ASSERT( unix_vkCmdResetEvent2KHR == 149 );
VK_FAST_THUNK( vkCmdResetEvent2KHR, "149", 3 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 4
C_ASSERT( unix_vkCmdResetQueryPool == 150 );
VK_FAST_THUNK( vkCmdResetQueryPool, "150", 4 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 7
C_ASSERT( unix_vkCmdResolveImage == 151 );
VK_FAST_THUNK( vkCmdResolveImage, "151", 7 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdResolveImage2 == 152 );
VK_FAST_THUNK( vkCmdResolveImage2, "152", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdResolveImage2KHR == 153 );
VK_FAST_THUNK( vkCmdResolveImage2KHR, "153", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetAlphaToCoverageEnableEXT == 154 );
VK_FAST_THUNK( vkCmdSetAlphaToCoverageEnableEXT, "154", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetAlphaToOneEnableEXT == 155 );
VK_FAST_THUNK( vkCmdSetAlphaToOneEnableEXT, "155", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetAttachmentFeedbackLoopEnableEXT == 156 );
VK_FAST_THUNK( vkCmdSetAttachmentFeedbackLoopEnableEXT, "156", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetBlendConstants == 157 );
VK_FAST_THUNK( vkCmdSetBlendConstants, "157", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetCheckpointNV == 158 );
VK_FAST_THUNK( vkCmdSetCheckpointNV, "158", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 4
C_ASSERT( unix_vkCmdSetCoarseSampleOrderNV == 159 );
VK_FAST_THUNK( vkCmdSetCoarseSampleOrderNV, "159", 4 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 4
C_ASSERT( unix_vkCmdSetColorBlendAdvancedEXT == 160 );
VK_FAST_THUNK( vkCmdSetColorBlendAdvancedEXT, "160", 4 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 4
C_ASSERT( unix_vkCmdSetColorBlendEnableEXT == 161 );
VK_FAST_THUNK( vkCmdSetColorBlendEnableEXT, "161", 4 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 4
C_ASSERT( unix_vkCmdSetColorBlendEquationEXT == 162 );
VK_FAST_THUNK( vkCmdSetColorBlendEquationEXT, "162", 4 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 3
C_ASSERT( unix_vkCmdSetColorWriteEnableEXT == 163 );
VK_FAST_THUNK( vkCmdSetColorWriteEnableEXT, "163", 3 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 4
C_ASSERT( unix_vkCmdSetColorWriteMaskEXT == 164 );
VK_FAST_THUNK( vkCmdSetColorWriteMaskEXT, "164", 4 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetConservativeRasterizationModeEXT == 165 );
VK_FAST_THUNK( vkCmdSetConservativeRasterizationModeEXT, "165", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetCoverageModulationModeNV == 166 );
VK_FAST_THUNK( vkCmdSetCoverageModulationModeNV, "166", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetCoverageModulationTableEnableNV == 167 );
VK_FAST_THUNK( vkCmdSetCoverageModulationTableEnableNV, "167", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 3
C_ASSERT( unix_vkCmdSetCoverageModulationTableNV == 168 );
VK_FAST_THUNK( vkCmdSetCoverageModulationTableNV, "168", 3 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetCoverageReductionModeNV == 169 );
VK_FAST_THUNK( vkCmdSetCoverageReductionModeNV, "169", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetCoverageToColorEnableNV == 170 );
VK_FAST_THUNK( vkCmdSetCoverageToColorEnableNV, "170", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetCoverageToColorLocationNV == 171 );
VK_FAST_THUNK( vkCmdSetCoverageToColorLocationNV, "171", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetCullMode == 172 );
VK_FAST_THUNK( vkCmdSetCullMode, "172", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetCullModeEXT == 173 );
VK_FAST_THUNK( vkCmdSetCullModeEXT, "173", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetDepthBias2EXT == 175 );
VK_FAST_THUNK( vkCmdSetDepthBias2EXT, "175", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetDepthBiasEnable == 176 );
VK_FAST_THUNK( vkCmdSetDepthBiasEnable, "176", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetDepthBiasEnableEXT == 177 );
VK_FAST_THUNK( vkCmdSetDepthBiasEnableEXT, "177", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetDepthBoundsTestEnable == 179 );
VK_FAST_THUNK( vkCmdSetDepthBoundsTestEnable, "179", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetDepthBoundsTestEnableEXT == 180 );
VK_FAST_THUNK( vkCmdSetDepthBoundsTestEnableEXT, "180", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetDepthClampEnableEXT == 181 );
VK_FAST_THUNK( vkCmdSetDepthClampEnableEXT, "181", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 3
C_ASSERT( unix_vkCmdSetDepthClampRangeEXT == 182 );
VK_FAST_THUNK( vkCmdSetDepthClampRangeEXT, "182", 3 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetDepthClipEnableEXT == 183 );
VK_FAST_THUNK( vkCmdSetDepthClipEnableEXT, "183", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetDepthClipNegativeOneToOneEXT == 184 );
VK_FAST_THUNK( vkCmdSetDepthClipNegativeOneToOneEXT, "184", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetDepthCompareOp == 185 );
VK_FAST_THUNK( vkCmdSetDepthCompareOp, "185", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetDepthCompareOpEXT == 186 );
VK_FAST_THUNK( vkCmdSetDepthCompareOpEXT, "186", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetDepthTestEnable == 187 );
VK_FAST_THUNK( vkCmdSetDepthTestEnable, "187", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetDepthTestEnableEXT == 188 );
VK_FAST_THUNK( vkCmdSetDepthTestEnableEXT, "188", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetDepthWriteEnable == 189 );
VK_FAST_THUNK( vkCmdSetDepthWriteEnable, "189", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetDepthWriteEnableEXT == 190 );
VK_FAST_THUNK( vkCmdSetDepthWriteEnableEXT, "190", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetDescriptorBufferOffsets2EXT == 191 );
VK_FAST_THUNK( vkCmdSetDescriptorBufferOffsets2EXT, "191", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 7
C_ASSERT( unix_vkCmdSetDescriptorBufferOffsetsEXT == 192 );
VK_FAST_THUNK( vkCmdSetDescriptorBufferOffsetsEXT, "192", 7 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetDeviceMask == 193 );
VK_FAST_THUNK( vkCmdSetDeviceMask, "193", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetDeviceMaskKHR == 194 );
VK_FAST_THUNK( vkCmdSetDeviceMaskKHR, "194", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 4
C_ASSERT( unix_vkCmdSetDiscardRectangleEXT == 195 );
VK_FAST_THUNK( vkCmdSetDiscardRectangleEXT, "195", 4 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetDiscardRectangleEnableEXT == 196 );
VK_FAST_THUNK( vkCmdSetDiscardRectangleEnableEXT, "196", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetDiscardRectangleModeEXT == 197 );
VK_FAST_THUNK( vkCmdSetDiscardRectangleModeEXT, "197", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 3
C_ASSERT( unix_vkCmdSetEvent == 198 );
VK_FAST_THUNK( vkCmdSetEvent, "198", 3 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 3
C_ASSERT( unix_vkCmdSetEvent2 == 199 );
VK_FAST_THUNK( vkCmdSetEvent2, "199", 3 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 3
C_ASSERT( unix_vkCmdSetEvent2KHR == 200 );
VK_FAST_THUNK( vkCmdSetEvent2KHR, "200", 3 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 4
C_ASSERT( unix_vkCmdSetExclusiveScissorEnableNV == 201 );
VK_FAST_THUNK( vkCmdSetExclusiveScissorEnableNV, "201", 4 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 4
C_ASSERT( unix_vkCmdSetExclusiveScissorNV == 202 );
VK_FAST_THUNK( vkCmdSetExclusiveScissorNV, "202", 4 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 3
C_ASSERT( unix_vkCmdSetFragmentShadingRateEnumNV == 204 );
VK_FAST_THUNK( vkCmdSetFragmentShadingRateEnumNV, "204", 3 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 3
C_ASSERT( unix_vkCmdSetFragmentShadingRateKHR == 205 );
VK_FAST_THUNK( vkCmdSetFragmentShadingRateKHR, "205", 3 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetFrontFace == 206 );
VK_FAST_THUNK( vkCmdSetFrontFace, "206", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetFrontFaceEXT == 207 );
VK_FAST_THUNK( vkCmdSetFrontFaceEXT, "207", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetLineRasterizationModeEXT == 208 );
VK_FAST_THUNK( vkCmdSetLineRasterizationModeEXT, "208", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 3
C_ASSERT( unix_vkCmdSetLineStippleEXT == 209 );
VK_FAST_THUNK( vkCmdSetLineStippleEXT, "209", 3 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetLineStippleEnableEXT == 210 );
VK_FAST_THUNK( vkCmdSetLineStippleEnableEXT, "210", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 3
C_ASSERT( unix_vkCmdSetLineStippleKHR == 211 );
VK_FAST_THUNK( vkCmdSetLineStippleKHR, "211", 3 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetLogicOpEXT == 213 );
VK_FAST_THUNK( vkCmdSetLogicOpEXT, "213", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetLogicOpEnableEXT == 214 );
VK_FAST_THUNK( vkCmdSetLogicOpEnableEXT, "214", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetPatchControlPointsEXT == 215 );
VK_FAST_THUNK( vkCmdSetPatchControlPointsEXT, "215", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetPolygonModeEXT == 216 );
VK_FAST_THUNK( vkCmdSetPolygonModeEXT, "216", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetPrimitiveRestartEnable == 217 );
VK_FAST_THUNK( vkCmdSetPrimitiveRestartEnable, "217", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetPrimitiveRestartEnableEXT == 218 );
VK_FAST_THUNK( vkCmdSetPrimitiveRestartEnableEXT, "218", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetPrimitiveTopology == 219 );
VK_FAST_THUNK( vkCmdSetPrimitiveTopology, "219", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetPrimitiveTopologyEXT == 220 );
VK_FAST_THUNK( vkCmdSetPrimitiveTopologyEXT, "220", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetProvokingVertexModeEXT == 221 );
VK_FAST_THUNK( vkCmdSetProvokingVertexModeEXT, "221", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetRasterizationSamplesEXT == 222 );
VK_FAST_THUNK( vkCmdSetRasterizationSamplesEXT, "222", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetRasterizationStreamEXT == 223 );
VK_FAST_THUNK( vkCmdSetRasterizationStreamEXT, "223", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetRasterizerDiscardEnable == 224 );
VK_FAST_THUNK( vkCmdSetRasterizerDiscardEnable, "224", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetRasterizerDiscardEnableEXT == 225 );
VK_FAST_THUNK( vkCmdSetRasterizerDiscardEnableEXT, "225", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetRayTracingPipelineStackSizeKHR == 226 );
VK_FAST_THUNK( vkCmdSetRayTracingPipelineStackSizeKHR, "226", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetRenderingAttachmentLocationsKHR == 227 );
VK_FAST_THUNK( vkCmdSetRenderingAttachmentLocationsKHR, "227", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetRenderingInputAttachmentIndicesKHR == 228 );
VK_FAST_THUNK( vkCmdSetRenderingInputAttachmentIndicesKHR, "228", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetRepresentativeFragmentTestEnableNV == 229 );
VK_FAST_THUNK( vkCmdSetRepresentativeFragmentTestEnableNV, "229", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetSampleLocationsEXT == 230 );
VK_FAST_THUNK( vkCmdSetSampleLocationsEXT, "230", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetSampleLocationsEnableEXT == 231 );
VK_FAST_THUNK( vkCmdSetSampleLocationsEnableEXT, "231", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 3
C_ASSERT( unix_vkCmdSetSampleMaskEXT == 232 );
VK_FAST_THUNK( vkCmdSetSampleMaskEXT, "232", 3 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 4
C_ASSERT( unix_vkCmdSetScissor == 233 );
VK_FAST_THUNK( vkCmdSetScissor, "233", 4 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 3
C_ASSERT( unix_vkCmdSetScissorWithCount == 234 );
VK_FAST_THUNK( vkCmdSetScissorWithCount, "234", 3 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 3
C_ASSERT( unix_vkCmdSetScissorWithCountEXT == 235 );
VK_FAST_THUNK( vkCmdSetScissorWithCountEXT, "235", 3 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetShadingRateImageEnableNV == 236 );
VK_FAST_THUNK( vkCmdSetShadingRateImageEnableNV, "236", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 3
C_ASSERT( unix_vkCmdSetStencilCompareMask == 237 );
VK_FAST_THUNK( vkCmdSetStencilCompareMask, "237", 3 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 6
C_ASSERT( unix_vkCmdSetStencilOp == 238 );
VK_FAST_THUNK( vkCmdSetStencilOp, "238", 6 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 6
C_ASSERT( unix_vkCmdSetStencilOpEXT == 239 );
VK_FAST_THUNK( vkCmdSetStencilOpEXT, "239", 6 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 3
C_ASSERT( unix_vkCmdSetStencilReference == 240 );
VK_FAST_THUNK( vkCmdSetStencilReference, "240", 3 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetStencilTestEnable == 241 );
VK_FAST_THUNK( vkCmdSetStencilTestEnable, "241", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetStencilTestEnableEXT == 242 );
VK_FAST_THUNK( vkCmdSetStencilTestEnableEXT, "242", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 3
C_ASSERT( unix_vkCmdSetStencilWriteMask == 243 );
VK_FAST_THUNK( vkCmdSetStencilWriteMask, "243", 3 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetTessellationDomainOriginEXT == 244 );
VK_FAST_THUNK( vkCmdSetTessellationDomainOriginEXT, "244", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 5
C_ASSERT( unix_vkCmdSetVertexInputEXT == 245 );
VK_FAST_THUNK( vkCmdSetVertexInputEXT, "245", 5 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 4
C_ASSERT( unix_vkCmdSetViewport == 246 );
VK_FAST_THUNK( vkCmdSetViewport, "246", 4 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 4
C_ASSERT( unix_vkCmdSetViewportShadingRatePaletteNV == 247 );
VK_FAST_THUNK( vkCmdSetViewportShadingRatePaletteNV, "247", 4 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 4
C_ASSERT( unix_vkCmdSetViewportSwizzleNV == 248 );
VK_FAST_THUNK( vkCmdSetViewportSwizzleNV, "248", 4 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetViewportWScalingEnableNV == 249 );
VK_FAST_THUNK( vkCmdSetViewportWScalingEnableNV, "249", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 4
C_ASSERT( unix_vkCmdSetViewportWScalingNV == 250 );
VK_FAST_THUNK( vkCmdSetViewportWScalingNV, "250", 4 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 3
C_ASSERT( unix_vkCmdSetViewportWithCount == 251 );
VK_FAST_THUNK( vkCmdSetViewportWithCount, "251", 3 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 3
C_ASSERT( unix_vkCmdSetViewportWithCountEXT == 252 );
VK_FAST_THUNK( vkCmdSetViewportWithCountEXT, "252", 3 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 1
C_ASSERT( unix_vkCmdSubpassShadingHUAWEI == 253 );
VK_FAST_THUNK( vkCmdSubpassShadingHUAWEI, "253", 1 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdTraceRaysIndirect2KHR == 254 );
VK_FAST_THUNK( vkCmdTraceRaysIndirect2KHR, "254", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 6
C_ASSERT( unix_vkCmdTraceRaysIndirectKHR == 255 );
VK_FAST_THUNK( vkCmdTraceRaysIndirectKHR, "255", 6 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 8
C_ASSERT( unix_vkCmdTraceRaysKHR == 256 );
VK_FAST_THUNK( vkCmdTraceRaysKHR, "256", 8 )
#else
...
C_ASSERT( unix_vkCmdTraceRaysNV == 257 );
VK_FAST_THUNK( vkCmdTraceRaysNV, "257", 15 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 5
C_ASSERT( unix_vkCmdUpdateBuffer == 258 );
VK_FAST_THUNK( vkCmdUpdateBuffer, "258", 5 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 3
C_ASSERT( unix_vkCmdUpdatePipelineIndirectBufferNV == 259 );
VK_FAST_THUNK( vkCmdUpdatePipelineIndirectBufferNV, "259", 3 )
#else
...
C_ASSERT( unix_vkCmdWaitEvents == 260 );
VK_FAST_THUNK( vkCmdWaitEvents, "260", 11 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 4
C_ASSERT( unix_vkCmdWaitEvents2 == 261 );
VK_FAST_THUNK( vkCmdWaitEvents2, "261", 4 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 4
C_ASSERT( unix_vkCmdWaitEvents2KHR == 262 );
VK_FAST_THUNK( vkCmdWaitEvents2KHR, "262", 4 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 6
C_ASSERT( unix_vkCmdWriteAccelerationStructuresPropertiesKHR == 263 );
VK_FAST_THUNK( vkCmdWriteAccelerationStructuresPropertiesKHR, "263", 6 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 6
C_ASSERT( unix_vkCmdWriteAccelerationStructuresPropertiesNV == 264 );
VK_FAST_THUNK( vkCmdWriteAccelerationStructuresPropertiesNV, "264", 6 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 5
C_ASSERT( unix_vkCmdWriteBufferMarker2AMD == 265 );
VK_FAST_THUNK( vkCmdWriteBufferMarker2AMD, "265", 5 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 5
C_ASSERT( unix_vkCmdWriteBufferMarkerAMD == 266 );
VK_FAST_THUNK( vkCmdWriteBufferMarkerAMD, "266", 5 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 6
C_ASSERT( unix_vkCmdWriteMicromapsPropertiesEXT == 267 );
VK_FAST_THUNK( vkCmdWriteMicromapsPropertiesEXT, "267", 6 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 4
C_ASSERT( unix_vkCmdWriteTimestamp == 268 );
VK_FAST_THUNK( vkCmdWriteTimestamp, "268", 4 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 4
C_ASSERT( unix_vkCmdWriteTimestamp2 == 269 );
VK_FAST_THUNK( vkCmdWriteTimestamp2, "269", 4 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 4
C_ASSERT( unix_vkCmdWriteTimestamp2KHR == 270 );
VK_FAST_THUNK( vkCmdWriteTimestamp2KHR, "270", 4 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 4
C_ASSERT( unix_vkGetDescriptorEXT == 417 );
VK_FAST_THUNK( vkGetDescriptorEXT, "417", 4 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 4
C_ASSERT( unix_vkUpdateDescriptorSetWithTemplate == 589 );
VK_FAST_THUNK( vkUpdateDescriptorSetWithTemplate, "589", 4 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 5
C_ASSERT( unix_vkUpdateDescriptorSets == 591 );
VK_FAST_THUNK( vkUpdateDescriptorSets, "591", 5 )
#else
