...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 3
C_ASSERT( unix_vkCmdBuildMicromapsEXT == 57 );
VK_FAST_THUNK( vkCmdBuildMicromapsEXT, "57", 3 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 5
C_ASSERT( unix_vkCmdClearAttachments == 58 );
VK_FAST_THUNK( vkCmdClearAttachments, "58", 5 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 6
C_ASSERT( unix_vkCmdClearColorImage == 59 );
VK_FAST_THUNK( vkCmdClearColorImage, "59", 6 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 6
C_ASSERT( unix_vkCmdClearDepthStencilImage == 60 );
VK_FAST_THUNK( vkCmdClearDepthStencilImage, "60", 6 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdControlVideoCodingKHR == 61 );
VK_FAST_THUNK( vkCmdControlVideoCodingKHR, "61", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdCopyAccelerationStructureKHR == 62 );
VK_FAST_THUNK( vkCmdCopyAccelerationStructureKHR, "62", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 4
C_ASSERT( unix_vkCmdCopyAccelerationStructureNV == 63 );
VK_FAST_THUNK( vkCmdCopyAccelerationStructureNV, "63", 4 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdCopyAccelerationStructureToMemoryKHR == 64 );
VK_FAST_THUNK( vkCmdCopyAccelerationStructureToMemoryKHR, "64", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 5
C_ASSERT( unix_vkCmdCopyBuffer == 65 );
VK_FAST_THUNK( vkCmdCopyBuffer, "65", 5 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdCopyBuffer2 == 66 );
VK_FAST_THUNK( vkCmdCopyBuffer2, "66", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdCopyBuffer2KHR == 67 );
VK_FAST_THUNK( vkCmdCopyBuffer2KHR, "67", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 6
C_ASSERT( unix_vkCmdCopyBufferToImage == 68 );
VK_FAST_THUNK( vkCmdCopyBufferToImage, "68", 6 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdCopyBufferToImage2 == 69 );
VK_FAST_THUNK( vkCmdCopyBufferToImage2, "69", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdCopyBufferToImage2KHR == 70 );
VK_FAST_THUNK( vkCmdCopyBufferToImage2KHR, "70", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 7
C_ASSERT( unix_vkCmdCopyImage == 71 );
VK_FAST_THUNK( vkCmdCopyImage, "71", 7 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdCopyImage2 == 72 );
VK_FAST_THUNK( vkCmdCopyImage2, "72", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdCopyImage2KHR == 73 );
VK_FAST_THUNK( vkCmdCopyImage2KHR, "73", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 6
C_ASSERT( unix_vkCmdCopyImageToBuffer == 74 );
VK_FAST_THUNK( vkCmdCopyImageToBuffer, "74", 6 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdCopyImageToBuffer2 == 75 );
VK_FAST_THUNK( vkCmdCopyImageToBuffer2, "75", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdCopyImageToBuffer2KHR == 76 );
VK_FAST_THUNK( vkCmdCopyImageToBuffer2KHR, "76", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 4
C_ASSERT( unix_vkCmdCopyMemoryIndirectNV == 77 );
VK_FAST_THUNK( vkCmdCopyMemoryIndirectNV, "77", 4 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdCopyMemoryToAccelerationStructureKHR == 78 );
VK_FAST_THUNK( vkCmdCopyMemoryToAccelerationStructureKHR, "78", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 7
C_ASSERT( unix_vkCmdCopyMemoryToImageIndirectNV == 79 );
VK_FAST_THUNK( vkCmdCopyMemoryToImageIndirectNV, "79", 7 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdCopyMemoryToMicromapEXT == 80 );
VK_FAST_THUNK( vkCmdCopyMemoryToMicromapEXT, "80", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdCopyMicromapEXT == 81 );
VK_FAST_THUNK( vkCmdCopyMicromapEXT, "81", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdCopyMicromapToMemoryEXT == 82 );
VK_FAST_THUNK( vkCmdCopyMicromapToMemoryEXT, "82", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 8
C_ASSERT( unix_vkCmdCopyQueryPoolResults == 83 );
VK_FAST_THUNK( vkCmdCopyQueryPoolResults, "83", 8 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdCuLaunchKernelNVX == 84 );
VK_FAST_THUNK( vkCmdCuLaunchKernelNVX, "84", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdCudaLaunchKernelNV == 85 );
VK_FAST_THUNK( vkCmdCudaLaunchKernelNV, "85", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdDebugMarkerBeginEXT == 86 );
VK_FAST_THUNK( vkCmdDebugMarkerBeginEXT, "86", 2 )
#else
...
C_ASSERT( unix_vkCmdDebugMarkerEndEXT == 87 );
VK_FAST_THUNK( vkCmdDebugMarkerEndEXT, "87", 1 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdDebugMarkerInsertEXT == 88 );
VK_FAST_THUNK( vkCmdDebugMarkerInsertEXT, "88", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdDecodeVideoKHR == 89 );
VK_FAST_THUNK( vkCmdDecodeVideoKHR, "89", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 4
C_ASSERT( unix_vkCmdDecompressMemoryIndirectCountNV == 90 );
VK_FAST_THUNK( vkCmdDecompressMemoryIndirectCountNV, "90", 4 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 3
C_ASSERT( unix_vkCmdDecompressMemoryNV == 91 );
VK_FAST_THUNK( vkCmdDecompressMemoryNV, "91", 3 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 4
C_ASSERT( unix_vkCmdDispatch == 92 );
VK_FAST_THUNK( vkCmdDispatch, "92", 4 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 7
C_ASSERT( unix_vkCmdDispatchBase == 93 );
VK_FAST_THUNK( vkCmdDispatchBase, "93", 7 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 7
C_ASSERT( unix_vkCmdDispatchBaseKHR == 94 );
VK_FAST_THUNK( vkCmdDispatchBaseKHR, "94", 7 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 3
C_ASSERT( unix_vkCmdDispatchIndirect == 95 );
VK_FAST_THUNK( vkCmdDispatchIndirect, "95", 3 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 5
C_ASSERT( unix_vkCmdDraw == 96 );
VK_FAST_THUNK( vkCmdDraw, "96", 5 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 4
C_ASSERT( unix_vkCmdDrawClusterHUAWEI == 97 );
VK_FAST_THUNK( vkCmdDrawClusterHUAWEI, "97", 4 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 3
C_ASSERT( unix_vkCmdDrawClusterIndirectHUAWEI == 98 );
VK_FAST_THUNK( vkCmdDrawClusterIndirectHUAWEI, "98", 3 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 6
C_ASSERT( unix_vkCmdDrawIndexed == 99 );
VK_FAST_THUNK( vkCmdDrawIndexed, "99", 6 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 5
C_ASSERT( unix_vkCmdDrawIndexedIndirect == 100 );
VK_FAST_THUNK( vkCmdDrawIndexedIndirect, "100", 5 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 7
C_ASSERT( unix_vkCmdDrawIndexedIndirectCount == 101 );
VK_FAST_THUNK( vkCmdDrawIndexedIndirectCount, "101", 7 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 7
C_ASSERT( unix_vkCmdDrawIndexedIndirectCountAMD == 102 );
VK_FAST_THUNK( vkCmdDrawIndexedIndirectCountAMD, "102", 7 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 7
C_ASSERT( unix_vkCmdDrawIndexedIndirectCountKHR == 103 );
VK_FAST_THUNK( vkCmdDrawIndexedIndirectCountKHR, "103", 7 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 5
C_ASSERT( unix_vkCmdDrawIndirect == 104 );
VK_FAST_THUNK( vkCmdDrawIndirect, "104", 5 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 7
C_ASSERT( unix_vkCmdDrawIndirectByteCountEXT == 105 );
VK_FAST_THUNK( vkCmdDrawIndirectByteCountEXT, "105", 7 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 7
C_ASSERT( unix_vkCmdDrawIndirectCount == 106 );
VK_FAST_THUNK( vkCmdDrawIndirectCount, "106", 7 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 7
C_ASSERT( unix_vkCmdDrawIndirectCountAMD == 107 );
VK_FAST_THUNK( vkCmdDrawIndirectCountAMD, "107", 7 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 7
C_ASSERT( unix_vkCmdDrawIndirectCountKHR == 108 );
VK_FAST_THUNK( vkCmdDrawIndirectCountKHR, "108", 7 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 4
C_ASSERT( unix_vkCmdDrawMeshTasksEXT == 109 );
VK_FAST_THUNK( vkCmdDrawMeshTasksEXT, "109", 4 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 7
C_ASSERT( unix_vkCmdDrawMeshTasksIndirectCountEXT == 110 );
VK_FAST_THUNK( vkCmdDrawMeshTasksIndirectCountEXT, "110", 7 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 7
C_ASSERT( unix_vkCmdDrawMeshTasksIndirectCountNV == 111 );
VK_FAST_THUNK( vkCmdDrawMeshTasksIndirectCountNV, "111", 7 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 5
C_ASSERT( unix_vkCmdDrawMeshTasksIndirectEXT == 112 );
VK_FAST_THUNK( vkCmdDrawMeshTasksIndirectEXT, "112", 5 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 5
C_ASSERT( unix_vkCmdDrawMeshTasksIndirectNV == 113 );
VK_FAST_THUNK( vkCmdDrawMeshTasksIndirectNV, "113", 5 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 3
C_ASSERT( unix_vkCmdDrawMeshTasksNV == 114 );
VK_FAST_THUNK( vkCmdDrawMeshTasksNV, "114", 3 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 6
C_ASSERT( unix_vkCmdDrawMultiEXT == 115 );
VK_FAST_THUNK( vkCmdDrawMultiEXT, "115", 6 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 7
C_ASSERT( unix_vkCmdDrawMultiIndexedEXT == 116 );
VK_FAST_THUNK( vkCmdDrawMultiIndexedEXT, "116", 7 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdEncodeVideoKHR == 117 );
VK_FAST_THUNK( vkCmdEncodeVideoKHR, "117", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 1
C_ASSERT( unix_vkCmdEndConditionalRenderingEXT == 118 );
VK_FAST_THUNK( vkCmdEndConditionalRenderingEXT, "118", 1 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 1
C_ASSERT( unix_vkCmdEndDebugUtilsLabelEXT == 119 );
VK_FAST_THUNK( vkCmdEndDebugUtilsLabelEXT, "119", 1 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 3
C_ASSERT( unix_vkCmdEndQuery == 120 );
VK_FAST_THUNK( vkCmdEndQuery, "120", 3 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 4
C_ASSERT( unix_vkCmdEndQueryIndexedEXT == 121 );
VK_FAST_THUNK( vkCmdEndQueryIndexedEXT, "121", 4 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 1
C_ASSERT( unix_vkCmdEndRenderPass == 122 );
VK_FAST_THUNK( vkCmdEndRenderPass, "122", 1 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdEndRenderPass2 == 123 );
VK_FAST_THUNK( vkCmdEndRenderPass2, "123", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdEndRenderPass2KHR == 124 );
VK_FAST_THUNK( vkCmdEndRenderPass2KHR, "124", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 1
C_ASSERT( unix_vkCmdEndRendering == 125 );
VK_FAST_THUNK( vkCmdEndRendering, "125", 1 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 1
C_ASSERT( unix_vkCmdEndRenderingKHR == 126 );
VK_FAST_THUNK( vkCmdEndRenderingKHR, "126", 1 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 5
C_ASSERT( unix_vkCmdEndTransformFeedbackEXT == 127 );
VK_FAST_THUNK( vkCmdEndTransformFeedbackEXT, "127", 5 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdEndVideoCodingKHR == 128 );
VK_FAST_THUNK( vkCmdEndVideoCodingKHR, "128", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 3
C_ASSERT( unix_vkCmdExecuteCommands == 129 );
VK_FAST_THUNK( vkCmdExecuteCommands, "129", 3 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 3
C_ASSERT( unix_vkCmdExecuteGeneratedCommandsEXT == 130 );
VK_FAST_THUNK( vkCmdExecuteGeneratedCommandsEXT, "130", 3 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 3
C_ASSERT( unix_vkCmdExecuteGeneratedCommandsNV == 131 );
VK_FAST_THUNK( vkCmdExecuteGeneratedCommandsNV, "131", 3 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 5
C_ASSERT( unix_vkCmdFillBuffer == 132 );
VK_FAST_THUNK( vkCmdFillBuffer, "132", 5 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdInsertDebugUtilsLabelEXT == 133 );
VK_FAST_THUNK( vkCmdInsertDebugUtilsLabelEXT, "133", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdNextSubpass == 134 );
VK_FAST_THUNK( vkCmdNextSubpass, "134", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 3
C_ASSERT( unix_vkCmdNextSubpass2 == 135 );
VK_FAST_THUNK( vkCmdNextSubpass2, "135", 3 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 3
C_ASSERT( unix_vkCmdNextSubpass2KHR == 136 );
VK_FAST_THUNK( vkCmdNextSubpass2KHR, "136", 3 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 3
C_ASSERT( unix_vkCmdOpticalFlowExecuteNV == 137 );
VK_FAST_THUNK( vkCmdOpticalFlowExecuteNV, "137", 3 )
#else
...
C_ASSERT( unix_vkCmdPipelineBarrier == 138 );
VK_FAST_THUNK( vkCmdPipelineBarrier, "138", 10 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdPipelineBarrier2 == 139 );
VK_FAST_THUNK( vkCmdPipelineBarrier2, "139", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdPipelineBarrier2KHR == 140 );
VK_FAST_THUNK( vkCmdPipelineBarrier2KHR, "140", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 3
C_ASSERT( unix_vkCmdPreprocessGeneratedCommandsEXT == 141 );
VK_FAST_THUNK( vkCmdPreprocessGeneratedCommandsEXT, "141", 3 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdPreprocessGeneratedCommandsNV == 142 );
VK_FAST_THUNK( vkCmdPreprocessGeneratedCommandsNV, "142", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 6
C_ASSERT( unix_vkCmdPushConstants == 143 );
VK_FAST_THUNK( vkCmdPushConstants, "143", 6 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdPushConstants2 == 144 );
VK_FAST_THUNK( vkCmdPushConstants2, "144", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdPushConstants2KHR == 145 );
VK_FAST_THUNK( vkCmdPushConstants2KHR, "145", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 6
C_ASSERT( unix_vkCmdPushDescriptorSet == 146 );
VK_FAST_THUNK( vkCmdPushDescriptorSet, "146", 6 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdPushDescriptorSet2 == 147 );
VK_FAST_THUNK( vkCmdPushDescriptorSet2, "147", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdPushDescriptorSet2KHR == 148 );
VK_FAST_THUNK( vkCmdPushDescriptorSet2KHR, "148", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 6
C_ASSERT( unix_vkCmdPushDescriptorSetKHR == 149 );
VK_FAST_THUNK( vkCmdPushDescriptorSetKHR, "149", 6 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 5
C_ASSERT( unix_vkCmdPushDescriptorSetWithTemplate == 150 );
VK_FAST_THUNK( vkCmdPushDescriptorSetWithTemplate, "150", 5 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdPushDescriptorSetWithTemplate2 == 151 );
VK_FAST_THUNK( vkCmdPushDescriptorSetWithTemplate2, "151", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdPushDescriptorSetWithTemplate2KHR == 152 );
VK_FAST_THUNK( vkCmdPushDescriptorSetWithTemplate2KHR, "152", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 5
C_ASSERT( unix_vkCmdPushDescriptorSetWithTemplateKHR == 153 );
VK_FAST_THUNK( vkCmdPushDescriptorSetWithTemplateKHR, "153", 5 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 3
C_ASSERT( unix_vkCmdResetEvent == 154 );
VK_FAST_THUNK( vkCmdResetEvent, "154", 3 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 3
C_ASSERT( unix_vkCmdResetEvent2 == 155 );
VK_FAST_THUNK( vkCmdResetEvent2, "155", 3 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 3
C_ASSERT( unix_vkCmdResetEvent2KHR == 156 );
VK_FAST_THUNK( vkCmdResetEvent2KHR, "156", 3 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 4
C_ASSERT( unix_vkCmdResetQueryPool == 157 );
VK_FAST_THUNK( vkCmdResetQueryPool, "157", 4 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 7
C_ASSERT( unix_vkCmdResolveImage == 158 );
VK_FAST_THUNK( vkCmdResolveImage, "158", 7 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdResolveImage2 == 159 );
VK_FAST_THUNK( vkCmdResolveImage2, "159", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdResolveImage2KHR == 160 );
VK_FAST_THUNK( vkCmdResolveImage2KHR, "160", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetAlphaToCoverageEnableEXT == 161 );
VK_FAST_THUNK( vkCmdSetAlphaToCoverageEnableEXT, "161", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetAlphaToOneEnableEXT == 162 );
VK_FAST_THUNK( vkCmdSetAlphaToOneEnableEXT, "162", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetAttachmentFeedbackLoopEnableEXT == 163 );
VK_FAST_THUNK( vkCmdSetAttachmentFeedbackLoopEnableEXT, "163", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetBlendConstants == 164 );
VK_FAST_THUNK( vkCmdSetBlendConstants, "164", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetCheckpointNV == 165 );
VK_FAST_THUNK( vkCmdSetCheckpointNV, "165", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 4
C_ASSERT( unix_vkCmdSetCoarseSampleOrderNV == 166 );
VK_FAST_THUNK( vkCmdSetCoarseSampleOrderNV, "166", 4 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 4
C_ASSERT( unix_vkCmdSetColorBlendAdvancedEXT == 167 );
VK_FAST_THUNK( vkCmdSetColorBlendAdvancedEXT, "167", 4 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 4
C_ASSERT( unix_vkCmdSetColorBlendEnableEXT == 168 );
VK_FAST_THUNK( vkCmdSetColorBlendEnableEXT, "168", 4 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 4
C_ASSERT( unix_vkCmdSetColorBlendEquationEXT == 169 );
VK_FAST_THUNK( vkCmdSetColorBlendEquationEXT, "169", 4 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 3
C_ASSERT( unix_vkCmdSetColorWriteEnableEXT == 170 );
VK_FAST_THUNK( vkCmdSetColorWriteEnableEXT, "170", 3 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 4
C_ASSERT( unix_vkCmdSetColorWriteMaskEXT == 171 );
VK_FAST_THUNK( vkCmdSetColorWriteMaskEXT, "171", 4 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetConservativeRasterizationModeEXT == 172 );
VK_FAST_THUNK( vkCmdSetConservativeRasterizationModeEXT, "172", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetCoverageModulationModeNV == 173 );
VK_FAST_THUNK( vkCmdSetCoverageModulationModeNV, "173", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetCoverageModulationTableEnableNV == 174 );
VK_FAST_THUNK( vkCmdSetCoverageModulationTableEnableNV, "174", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 3
C_ASSERT( unix_vkCmdSetCoverageModulationTableNV == 175 );
VK_FAST_THUNK( vkCmdSetCoverageModulationTableNV, "175", 3 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetCoverageReductionModeNV == 176 );
VK_FAST_THUNK( vkCmdSetCoverageReductionModeNV, "176", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetCoverageToColorEnableNV == 177 );
VK_FAST_THUNK( vkCmdSetCoverageToColorEnableNV, "177", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetCoverageToColorLocationNV == 178 );
VK_FAST_THUNK( vkCmdSetCoverageToColorLocationNV, "178", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetCullMode == 179 );
VK_FAST_THUNK( vkCmdSetCullMode, "179", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetCullModeEXT == 180 );
VK_FAST_THUNK( vkCmdSetCullModeEXT, "180", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetDepthBias2EXT == 182 );
VK_FAST_THUNK( vkCmdSetDepthBias2EXT, "182", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetDepthBiasEnable == 183 );
VK_FAST_THUNK( vkCmdSetDepthBiasEnable, "183", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetDepthBiasEnableEXT == 184 );
VK_FAST_THUNK( vkCmdSetDepthBiasEnableEXT, "184", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetDepthBoundsTestEnable == 186 );
VK_FAST_THUNK( vkCmdSetDepthBoundsTestEnable, "186", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetDepthBoundsTestEnableEXT == 187 );
VK_FAST_THUNK( vkCmdSetDepthBoundsTestEnableEXT, "187", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetDepthClampEnableEXT == 188 );
VK_FAST_THUNK( vkCmdSetDepthClampEnableEXT, "188", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 3
C_ASSERT( unix_vkCmdSetDepthClampRangeEXT == 189 );
VK_FAST_THUNK( vkCmdSetDepthClampRangeEXT, "189", 3 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetDepthClipEnableEXT == 190 );
VK_FAST_THUNK( vkCmdSetDepthClipEnableEXT, "190", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetDepthClipNegativeOneToOneEXT == 191 );
VK_FAST_THUNK( vkCmdSetDepthClipNegativeOneToOneEXT, "191", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetDepthCompareOp == 192 );
VK_FAST_THUNK( vkCmdSetDepthCompareOp, "192", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetDepthCompareOpEXT == 193 );
VK_FAST_THUNK( vkCmdSetDepthCompareOpEXT, "193", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetDepthTestEnable == 194 );
VK_FAST_THUNK( vkCmdSetDepthTestEnable, "194", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetDepthTestEnableEXT == 195 );
VK_FAST_THUNK( vkCmdSetDepthTestEnableEXT, "195", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetDepthWriteEnable == 196 );
VK_FAST_THUNK( vkCmdSetDepthWriteEnable, "196", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetDepthWriteEnableEXT == 197 );
VK_FAST_THUNK( vkCmdSetDepthWriteEnableEXT, "197", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetDescriptorBufferOffsets2EXT == 198 );
VK_FAST_THUNK( vkCmdSetDescriptorBufferOffsets2EXT, "198", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 7
C_ASSERT( unix_vkCmdSetDescriptorBufferOffsetsEXT == 199 );
VK_FAST_THUNK( vkCmdSetDescriptorBufferOffsetsEXT, "199", 7 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetDeviceMask == 200 );
VK_FAST_THUNK( vkCmdSetDeviceMask, "200", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetDeviceMaskKHR == 201 );
VK_FAST_THUNK( vkCmdSetDeviceMaskKHR, "201", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 4
C_ASSERT( unix_vkCmdSetDiscardRectangleEXT == 202 );
VK_FAST_THUNK( vkCmdSetDiscardRectangleEXT, "202", 4 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetDiscardRectangleEnableEXT == 203 );
VK_FAST_THUNK( vkCmdSetDiscardRectangleEnableEXT, "203", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetDiscardRectangleModeEXT == 204 );
VK_FAST_THUNK( vkCmdSetDiscardRectangleModeEXT, "204", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 3
C_ASSERT( unix_vkCmdSetEvent == 205 );
VK_FAST_THUNK( vkCmdSetEvent, "205", 3 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 3
C_ASSERT( unix_vkCmdSetEvent2 == 206 );
VK_FAST_THUNK( vkCmdSetEvent2, "206", 3 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 3
C_ASSERT( unix_vkCmdSetEvent2KHR == 207 );
VK_FAST_THUNK( vkCmdSetEvent2KHR, "207", 3 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 4
C_ASSERT( unix_vkCmdSetExclusiveScissorEnableNV == 208 );
VK_FAST_THUNK( vkCmdSetExclusiveScissorEnableNV, "208", 4 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 4
C_ASSERT( unix_vkCmdSetExclusiveScissorNV == 209 );
VK_FAST_THUNK( vkCmdSetExclusiveScissorNV, "209", 4 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 3
C_ASSERT( unix_vkCmdSetFragmentShadingRateEnumNV == 211 );
VK_FAST_THUNK( vkCmdSetFragmentShadingRateEnumNV, "211", 3 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 3
C_ASSERT( unix_vkCmdSetFragmentShadingRateKHR == 212 );
VK_FAST_THUNK( vkCmdSetFragmentShadingRateKHR, "212", 3 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetFrontFace == 213 );
VK_FAST_THUNK( vkCmdSetFrontFace, "213", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetFrontFaceEXT == 214 );
VK_FAST_THUNK( vkCmdSetFrontFaceEXT, "214", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetLineRasterizationModeEXT == 215 );
VK_FAST_THUNK( vkCmdSetLineRasterizationModeEXT, "215", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 3
C_ASSERT( unix_vkCmdSetLineStipple == 216 );
VK_FAST_THUNK( vkCmdSetLineStipple, "216", 3 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 3
C_ASSERT( unix_vkCmdSetLineStippleEXT == 217 );
VK_FAST_THUNK( vkCmdSetLineStippleEXT, "217", 3 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetLineStippleEnableEXT == 218 );
VK_FAST_THUNK( vkCmdSetLineStippleEnableEXT, "218", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 3
C_ASSERT( unix_vkCmdSetLineStippleKHR == 219 );
VK_FAST_THUNK( vkCmdSetLineStippleKHR, "219", 3 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetLogicOpEXT == 221 );
VK_FAST_THUNK( vkCmdSetLogicOpEXT, "221", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetLogicOpEnableEXT == 222 );
VK_FAST_THUNK( vkCmdSetLogicOpEnableEXT, "222", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetPatchControlPointsEXT == 223 );
VK_FAST_THUNK( vkCmdSetPatchControlPointsEXT, "223", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetPolygonModeEXT == 224 );
VK_FAST_THUNK( vkCmdSetPolygonModeEXT, "224", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetPrimitiveRestartEnable == 225 );
VK_FAST_THUNK( vkCmdSetPrimitiveRestartEnable, "225", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetPrimitiveRestartEnableEXT == 226 );
VK_FAST_THUNK( vkCmdSetPrimitiveRestartEnableEXT, "226", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetPrimitiveTopology == 227 );
VK_FAST_THUNK( vkCmdSetPrimitiveTopology, "227", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetPrimitiveTopologyEXT == 228 );
VK_FAST_THUNK( vkCmdSetPrimitiveTopologyEXT, "228", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetProvokingVertexModeEXT == 229 );
VK_FAST_THUNK( vkCmdSetProvokingVertexModeEXT, "229", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetRasterizationSamplesEXT == 230 );
VK_FAST_THUNK( vkCmdSetRasterizationSamplesEXT, "230", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetRasterizationStreamEXT == 231 );
VK_FAST_THUNK( vkCmdSetRasterizationStreamEXT, "231", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetRasterizerDiscardEnable == 232 );
VK_FAST_THUNK( vkCmdSetRasterizerDiscardEnable, "232", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetRasterizerDiscardEnableEXT == 233 );
VK_FAST_THUNK( vkCmdSetRasterizerDiscardEnableEXT, "233", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetRayTracingPipelineStackSizeKHR == 234 );
VK_FAST_THUNK( vkCmdSetRayTracingPipelineStackSizeKHR, "234", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetRenderingAttachmentLocations == 235 );
VK_FAST_THUNK( vkCmdSetRenderingAttachmentLocations, "235", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetRenderingAttachmentLocationsKHR == 236 );
VK_FAST_THUNK( vkCmdSetRenderingAttachmentLocationsKHR, "236", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetRenderingInputAttachmentIndices == 237 );
VK_FAST_THUNK( vkCmdSetRenderingInputAttachmentIndices, "237", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetRenderingInputAttachmentIndicesKHR == 238 );
VK_FAST_THUNK( vkCmdSetRenderingInputAttachmentIndicesKHR, "238", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetRepresentativeFragmentTestEnableNV == 239 );
VK_FAST_THUNK( vkCmdSetRepresentativeFragmentTestEnableNV, "239", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetSampleLocationsEXT == 240 );
VK_FAST_THUNK( vkCmdSetSampleLocationsEXT, "240", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetSampleLocationsEnableEXT == 241 );
VK_FAST_THUNK( vkCmdSetSampleLocationsEnableEXT, "241", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 3
C_ASSERT( unix_vkCmdSetSampleMaskEXT == 242 );
VK_FAST_THUNK( vkCmdSetSampleMaskEXT, "242", 3 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 4
C_ASSERT( unix_vkCmdSetScissor == 243 );
VK_FAST_THUNK( vkCmdSetScissor, "243", 4 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 3
C_ASSERT( unix_vkCmdSetScissorWithCount == 244 );
VK_FAST_THUNK( vkCmdSetScissorWithCount, "244", 3 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 3
C_ASSERT( unix_vkCmdSetScissorWithCountEXT == 245 );
VK_FAST_THUNK( vkCmdSetScissorWithCountEXT, "245", 3 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetShadingRateImageEnableNV == 246 );
VK_FAST_THUNK( vkCmdSetShadingRateImageEnableNV, "246", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 3
C_ASSERT( unix_vkCmdSetStencilCompareMask == 247 );
VK_FAST_THUNK( vkCmdSetStencilCompareMask, "247", 3 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 6
C_ASSERT( unix_vkCmdSetStencilOp == 248 );
VK_FAST_THUNK( vkCmdSetStencilOp, "248", 6 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 6
C_ASSERT( unix_vkCmdSetStencilOpEXT == 249 );
VK_FAST_THUNK( vkCmdSetStencilOpEXT, "249", 6 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 3
C_ASSERT( unix_vkCmdSetStencilReference == 250 );
VK_FAST_THUNK( vkCmdSetStencilReference, "250", 3 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetStencilTestEnable == 251 );
VK_FAST_THUNK( vkCmdSetStencilTestEnable, "251", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetStencilTestEnableEXT == 252 );
VK_FAST_THUNK( vkCmdSetStencilTestEnableEXT, "252", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 3
C_ASSERT( unix_vkCmdSetStencilWriteMask == 253 );
VK_FAST_THUNK( vkCmdSetStencilWriteMask, "253", 3 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetTessellationDomainOriginEXT == 254 );
VK_FAST_THUNK( vkCmdSetTessellationDomainOriginEXT, "254", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 5
C_ASSERT( unix_vkCmdSetVertexInputEXT == 255 );
VK_FAST_THUNK( vkCmdSetVertexInputEXT, "255", 5 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 4
C_ASSERT( unix_vkCmdSetViewport == 256 );
VK_FAST_THUNK( vkCmdSetViewport, "256", 4 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 4
C_ASSERT( unix_vkCmdSetViewportShadingRatePaletteNV == 257 );
VK_FAST_THUNK( vkCmdSetViewportShadingRatePaletteNV, "257", 4 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 4
C_ASSERT( unix_vkCmdSetViewportSwizzleNV == 258 );
VK_FAST_THUNK( vkCmdSetViewportSwizzleNV, "258", 4 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdSetViewportWScalingEnableNV == 259 );
VK_FAST_THUNK( vkCmdSetViewportWScalingEnableNV, "259", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 4
C_ASSERT( unix_vkCmdSetViewportWScalingNV == 260 );
VK_FAST_THUNK( vkCmdSetViewportWScalingNV, "260", 4 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 3
C_ASSERT( unix_vkCmdSetViewportWithCount == 261 );
VK_FAST_THUNK( vkCmdSetViewportWithCount, "261", 3 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 3
C_ASSERT( unix_vkCmdSetViewportWithCountEXT == 262 );
VK_FAST_THUNK( vkCmdSetViewportWithCountEXT, "262", 3 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 1
C_ASSERT( unix_vkCmdSubpassShadingHUAWEI == 263 );
VK_FAST_THUNK( vkCmdSubpassShadingHUAWEI, "263", 1 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 2
C_ASSERT( unix_vkCmdTraceRaysIndirect2KHR == 264 );
VK_FAST_THUNK( vkCmdTraceRaysIndirect2KHR, "264", 2 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 6
C_ASSERT( unix_vkCmdTraceRaysIndirectKHR == 265 );
VK_FAST_THUNK( vkCmdTraceRaysIndirectKHR, "265", 6 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 8
C_ASSERT( unix_vkCmdTraceRaysKHR == 266 );
VK_FAST_THUNK( vkCmdTraceRaysKHR, "266", 8 )
#else
...
C_ASSERT( unix_vkCmdTraceRaysNV == 267 );
VK_FAST_THUNK( vkCmdTraceRaysNV, "267", 15 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 5
C_ASSERT( unix_vkCmdUpdateBuffer == 268 );
VK_FAST_THUNK( vkCmdUpdateBuffer, "268", 5 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 3
C_ASSERT( unix_vkCmdUpdatePipelineIndirectBufferNV == 269 );
VK_FAST_THUNK( vkCmdUpdatePipelineIndirectBufferNV, "269", 3 )
#else
...
C_ASSERT( unix_vkCmdWaitEvents == 270 );
VK_FAST_THUNK( vkCmdWaitEvents, "270", 11 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 4
C_ASSERT( unix_vkCmdWaitEvents2 == 271 );
VK_FAST_THUNK( vkCmdWaitEvents2, "271", 4 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 4
C_ASSERT( unix_vkCmdWaitEvents2KHR == 272 );
VK_FAST_THUNK( vkCmdWaitEvents2KHR, "272", 4 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 6
C_ASSERT( unix_vkCmdWriteAccelerationStructuresPropertiesKHR == 273 );
VK_FAST_THUNK( vkCmdWriteAccelerationStructuresPropertiesKHR, "273", 6 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 6
C_ASSERT( unix_vkCmdWriteAccelerationStructuresPropertiesNV == 274 );
VK_FAST_THUNK( vkCmdWriteAccelerationStructuresPropertiesNV, "274", 6 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 5
C_ASSERT( unix_vkCmdWriteBufferMarker2AMD == 275 );
VK_FAST_THUNK( vkCmdWriteBufferMarker2AMD, "275", 5 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 5
C_ASSERT( unix_vkCmdWriteBufferMarkerAMD == 276 );
VK_FAST_THUNK( vkCmdWriteBufferMarkerAMD, "276", 5 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 6
C_ASSERT( unix_vkCmdWriteMicromapsPropertiesEXT == 277 );
VK_FAST_THUNK( vkCmdWriteMicromapsPropertiesEXT, "277", 6 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 4
C_ASSERT( unix_vkCmdWriteTimestamp == 278 );
VK_FAST_THUNK( vkCmdWriteTimestamp, "278", 4 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 4
C_ASSERT( unix_vkCmdWriteTimestamp2 == 279 );
VK_FAST_THUNK( vkCmdWriteTimestamp2, "279", 4 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 4
C_ASSERT( unix_vkCmdWriteTimestamp2KHR == 280 );
VK_FAST_THUNK( vkCmdWriteTimestamp2KHR, "280", 4 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 4
C_ASSERT( unix_vkGetDescriptorEXT == 430 );
VK_FAST_THUNK( vkGetDescriptorEXT, "430", 4 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 4
C_ASSERT( unix_vkUpdateDescriptorSetWithTemplate == 610 );
VK_FAST_THUNK( vkUpdateDescriptorSetWithTemplate, "610", 4 )
#else
...
#if defined(VK_FAST_THUNK) && VK_FAST_THUNK_MAX_ARGS >= 5
C_ASSERT( unix_vkUpdateDescriptorSets == 612 );
VK_FAST_THUNK( vkUpdateDescriptorSets, "612", 5 )
#else
