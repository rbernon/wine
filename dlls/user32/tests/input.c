...
static const BYTE expect_wch2vk[0x100 * sizeof(WORD)] =
{
    ,
    ...
    0x58, 0x01, 0x59, 0x01, 0x5a, 0x01, 0xdb, 0x00, 0xdc, 0x00, 0xdd, 0x00, 0x36, 0x01, 0xbd, 0x01,
    0xc0, 0x00, 0x41, 0x00, 0x42, 0x00, 0x43, 0x00, 0x44, 0x00, 0x45, 0x00, 0x46, 0x00, 0x47, 0x00,
    ...
    0x58, 0x00, 0x59, 0x00, 0x5a, 0x00, 0xdb, 0x01, 0xdc, 0x01, 0xdd, 0x01, 0xc0, 0x01, 0x08, 0x02,
...
static void test_VkKeyScanEx(void)
{
    WORD wch2vk[0x100];
    UINT wch;

    for (wch = 0; wch < 0x100; ++wch)
        wch2vk[wch] = VkKeyScanExW( wch, 0 );

    if (memcmp( expect_wch2vk, wch2vk, sizeof(expect_wch2vk) ))
    {
        const unsigned char *ptr = (void *)wch2vk, *end = ptr + sizeof(wch2vk);
        ...
        ptr = (void *)expect_wch2vk, end = ptr + sizeof(expect_wch2vk);
        ok(0, "expect_wch2vk %p-%p (%x)\n", (void *)ptr, (void *)end, (int)(end - ptr));
        for (int i = 0, j; ptr + i < end;)
        {
            char buffer[256], *buf = buffer;
            buf += sprintf(buf, "%08x ", i);
...
static const BYTE expect_vk2vscex[0x10000 * sizeof(WORD)] =
{
    ,
};
static const BYTE expect_vk2vsc[0x10000 * sizeof(WORD)] =
{
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x46, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x0e, 0x00, 0x0f, 0x00, 0x00, 0x00, 0x00, 0x00, 0x4c, 0x00, 0x1c, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x2a, 0x00, 0x1d, 0x00, 0x38, 0x00, 0x00, 0x00, 0x3a, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x39, 0x00, 0x49, 0x00, 0x51, 0x00, 0x4f, 0x00, 0x47, 0x00, 0x4b, 0x00, 0x48, 0x00, 0x4d, 0x00,
    0x50, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x54, 0x00, 0x52, 0x00, 0x53, 0x00, 0x63, 0x00,
    0x0b, 0x00, 0x02, 0x00, 0x03, 0x00, 0x04, 0x00, 0x05, 0x00, 0x06, 0x00, 0x07, 0x00, 0x08, 0x00,
    ...
    ,
...
static const BYTE expect_vk2chr[0x10000 * sizeof(WORD)] =
{
    ,
    ...
    ,
};
static const BYTE expect_vsc2vk[0x300 * sizeof(UINT)] =
{
    ,
    ...
    ,
    ...
    0x84, 0x00, 0x00, 0x00, 0x85, 0x00, 0x00, 0x00, 0x86, 0x00, 0x00, 0x00, 0xed, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0xe9, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xc1, 0x00, 0x00, 0x00,
    ...
    0x09, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xc2, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
};
static const BYTE expect_vsc2vkex[0x300 * sizeof(UINT)] =
{
    0x00, 0x00, 0x00, 0x00, 0x1b, 0x00, 0x00, 0x00, 0x31, 0x00, 0x00, 0x00, 0x32, 0x00, 0x00, 0x00,
    0x33, 0x00, 0x00, 0x00, 0x34, 0x00, 0x00, 0x00, 0x35, 0x00, 0x00, 0x00, 0x36, 0x00, 0x00, 0x00,
    0x37, 0x00, 0x00, 0x00, 0x38, 0x00, 0x00, 0x00, 0x39, 0x00, 0x00, 0x00, 0x30, 0x00, 0x00, 0x00,
    ...
    ,
...
static void test_MapVirtualKeyEx(void)
{
    UINT vsc2vk[0x300] = {0}, vsc2vkex[0x300] = {0};
    WORD vk2vscex[0x10000], vk2vsc[0x10000];
    WCHAR vk2chr[0x10000];

    for (WORD scan = 0; scan < 0x100; ++scan)
    {
        vsc2vk[scan] = MapVirtualKeyExW( scan | (scan >= 0x100 ? 0xdf00 : 0), MAPVK_VSC_TO_VK, 0 );
        vsc2vkex[scan] = MapVirtualKeyExW( scan | (scan >= 0x100 ? 0xdf00 : 0), MAPVK_VSC_TO_VK_EX, 0 );
    }

    if (memcmp( vsc2vk, expect_vsc2vk, sizeof(vsc2vk) ))
    {
        const unsigned char *ptr = (void *)vsc2vk, *end = ptr + sizeof(vsc2vk);
        ok(0, "vsc2vk %p-%p (%x)\n", (void *)ptr, (void *)end, (int)(end - ptr));
        for (int i = 0, j; ptr + i < end;)
        {
            char buffer[256], *buf = buffer;
        ...
        ptr = (void *)expect_vsc2vk, end = ptr + sizeof(expect_vsc2vk);
        ok(0, "expect_vsc2vk %p-%p (%x)\n", (void *)ptr, (void *)end, (int)(end - ptr));
        for (int i = 0, j; ptr + i < end;)
        {
            char buffer[256], *buf = buffer;
            buf += sprintf(buf, "%08x ", i);
    ...
    if (memcmp( vsc2vkex, expect_vsc2vkex, sizeof(vsc2vkex) ))
    {
        const unsigned char *ptr = (void *)vsc2vkex, *end = ptr + sizeof(vsc2vkex);
        ok(0, "vsc2vkex %p-%p (%x)\n", (void *)ptr, (void *)end, (int)(end - ptr));
        for (int i = 0, j; ptr + i < end;)
        {
            char buffer[256], *buf = buffer;
    ...
    for (UINT vkey = 0; vkey <= 0xffff; ++vkey)
    {
        vk2vscex[vkey] = MapVirtualKeyExW( vkey, MAPVK_VK_TO_VSC_EX, 0 );
        vk2vsc[vkey] = MapVirtualKeyExW( vkey, MAPVK_VK_TO_VSC, 0 );
        vk2chr[vkey] = MapVirtualKeyExW( vkey, MAPVK_VK_TO_CHAR, 0 );
    }

    if (memcmp( vk2vscex, expect_vk2vscex, sizeof(vk2vscex) ))
    {
        const unsigned char *ptr = (void *)vk2vscex, *end = ptr + sizeof(vk2vscex);
        ok(0, "vk2vscex %p-%p (%x)\n", (void *)ptr, (void *)end, (int)(end - ptr));
        for (int i = 0, j; ptr + i < end;)
        {
            char buffer[256], *buf = buffer;
    ...
    if (memcmp( vk2vsc, expect_vk2vsc, sizeof(vk2vsc) ))
    {
        const unsigned char *ptr = (void *)vk2vsc, *end = ptr + sizeof(vk2vsc);
        ok(0, "vk2vsc %p-%p (%x)\n", (void *)ptr, (void *)end, (int)(end - ptr));
        for (int i = 0, j; ptr + i < end;)
        {
            char buffer[256], *buf = buffer;
    ...
    if (memcmp( vk2chr, expect_vk2chr, sizeof(vk2chr) ))
    {
        const unsigned char *ptr = (void *)vk2chr, *end = ptr + sizeof(vk2chr);
        ok(0, "vk2chr %p-%p (%x)\n", (void *)ptr, (void *)end, (int)(end - ptr));
        for (int i = 0, j; ptr + i < end;)
        {
            char buffer[256], *buf = buffer;
        ...
        ptr = (void *)expect_vk2chr, end = ptr + sizeof(expect_vk2chr);
        ok(0, "expect_vk2chr %p-%p (%x)\n", (void *)ptr, (void *)end, (int)(end - ptr));
        for (int i = 0, j; ptr + i < end;)
        {
            char buffer[256], *buf = buffer;
            buf += sprintf(buf, "%08x ", i);
...
static void test_GetKeyNameText(void)
{
}

static const BYTE expect_vk2wch[0x400 * sizeof(WCHAR)] =
{
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x03, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x08, 0x00, 0x09, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0d, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    ...
    0x30, 0x00, 0x31, 0x00, 0x32, 0x00, 0x33, 0x00, 0x34, 0x00, 0x35, 0x00, 0x36, 0x00, 0x37, 0x00,
    0x38, 0x00, 0x39, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x61, 0x00, 0x62, 0x00, 0x63, 0x00, 0x64, 0x00, 0x65, 0x00, 0x66, 0x00, 0x67, 0x00,
    ...
    0x78, 0x00, 0x79, 0x00, 0x7a, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x30, 0x00, 0x31, 0x00, 0x32, 0x00, 0x33, 0x00, 0x34, 0x00, 0x35, 0x00, 0x36, 0x00, 0x37, 0x00,
    0x38, 0x00, 0x39, 0x00, 0x2a, 0x00, 0x2b, 0x00, 0x00, 0x00, 0x2d, 0x00, 0x2e, 0x00, 0x2f, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    ...
    ,
    ...
    ,
    ...
    0x18, 0x00, 0x19, 0x00, 0x1a, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    ...
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x1b, 0x00, 0x1c, 0x00, 0x1d, 0x00, 0x00, 0x00, 0x00, 0x00,
...
static void test_ToUnicodeEx(void)
{
    WCHAR str[0x10], vk2wch[0x400];
    BYTE state[0x100] = {0};

    for (UINT vkey = 0; vkey <= 0xff; ++vkey)
    {
        DWORD ret = ToUnicodeEx( vkey, 0, state, str, ARRAY_SIZE(str), 0, 0 );
        if (vkey == 0xdd) ret = ToUnicodeEx( vkey, 0, state, str, ARRAY_SIZE(str), 0, 0 );
        else ok( ret <= 1, "%#x got ret %lu\n", vkey, ret );
        vk2wch[vkey] = str[0];
    }
    ...
    for (UINT vkey = 0; vkey <= 0xff; ++vkey)
    {
        DWORD ret = ToUnicodeEx( vkey, 0, state, str, ARRAY_SIZE(str), 0, 0 );
        ok( ret <= 1, "got ret %lu\n", ret );
        vk2wch[vkey + 0x300] = str[0];
    }

    if (memcmp( vk2wch, expect_vk2wch, sizeof(vk2wch) ))
    {
        const unsigned char *ptr = (void *)vk2wch, *end = ptr + sizeof(vk2wch);
        ok(0, "vk2wch %p-%p (%x)\n", (void *)ptr, (void *)end, (int)(end - ptr));
        for (int i = 0, j; ptr + i < end;)
        {
            char buffer[256], *buf = buffer;
        ...
        ptr = (void *)expect_vk2wch, end = ptr + sizeof(expect_vk2wch);
        ok(0, "expect_vk2wch %p-%p (%x)\n", (void *)ptr, (void *)end, (int)(end - ptr));
        for (int i = 0, j; ptr + i < end;)
        {
            char buffer[256], *buf = buffer;
            buf += sprintf(buf, "%08x ", i);
