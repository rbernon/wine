...
{
    RECT rect, expect = {100,100,300,300}, maximized = {0,0,1024,768}, minimized, minmaxed;
    HWND hwnd;
    ...
    hwnd = CreateWindowW( L"static", NULL, WS_OVERLAPPEDWINDOW,
                          100, 100, 200, 200, NULL, NULL, NULL, NULL );
    flush_events( TRUE );
    ok(0, "hidden -> normal overlapped %p\n", hwnd);
    ShowWindow( hwnd, SW_SHOW );
    flush_events( TRUE );
    ...
    SetWindowPos( hwnd, 0, 0, 0, 0, 0, SWP_NOSIZE | SWP_NOMOVE | SWP_FRAMECHANGED );
    flush_events( TRUE );
    ok(0, "normal -> hidden popup %p\n", hwnd);
    ShowWindow( hwnd, SW_HIDE );
    flush_events( TRUE );
    ok(0, "hidden -> normal popup %p\n", hwnd);
    ShowWindow( hwnd, SW_SHOW );
    flush_events( TRUE );
    ...
    SetWindowPos( hwnd, 0, 0, 0, 0, 0, SWP_NOSIZE | SWP_NOMOVE | SWP_FRAMECHANGED );
    flush_events( TRUE );
    ok(0, "normal -> hidden overlapped %p\n", hwnd);
    ShowWindow( hwnd, SW_HIDE );
    flush_events( TRUE );
    ok(0, "hidden -> normal overlapped %p\n", hwnd);
    ShowWindow( hwnd, SW_SHOW );
    ...
    ok(EqualRect(&rect, &expect), "rect %s\n", wine_dbgstr_rect(&rect));
    ...
    minimized = expect;
    OffsetRect(&minimized, -32000, -32000);
    minmaxed = maximized;
    OffsetRect(&minmaxed, -32000, -32000);

    ok(EqualRect(&rect, &expect), "rect %s\n", wine_dbgstr_rect(&rect));
    ok(0, "normal -> minimized popup %p\n", hwnd);
    ShowWindow( hwnd, SW_MINIMIZE );
    flush_events( TRUE );
    GetWindowRect( hwnd, &rect );
    ok(EqualRect(&rect, &minimized), "rect %s\n", wine_dbgstr_rect(&rect));
    ok(0, "minimized -> maximized popup %p\n", hwnd);
    ShowWindow( hwnd, SW_MAXIMIZE );
    flush_events( TRUE );
    GetWindowRect( hwnd, &rect );
    ok(EqualRect(&rect, &maximized), "rect %s\n", wine_dbgstr_rect(&rect));
    ok(0, "maximized -> normal popup %p\n", hwnd);
    ...
    GetWindowRect( hwnd, &rect );
    ok(EqualRect(&rect, &expect), "rect %s\n", wine_dbgstr_rect(&rect));
    ok(0, "hidden -> maximized popup %p\n", hwnd);
    ShowWindow( hwnd, SW_MAXIMIZE );
    flush_events( TRUE );
    GetWindowRect( hwnd, &rect );
    ok(EqualRect(&rect, &maximized), "rect %s\n", wine_dbgstr_rect(&rect));
    ok(0, "maximized -> minimized popup %p\n", hwnd);
    ShowWindow( hwnd, SW_MINIMIZE );
    flush_events( TRUE );
    GetWindowRect( hwnd, &rect );
    ok(EqualRect(&rect, &minmaxed), "rect %s\n", wine_dbgstr_rect(&rect));
    ok(0, "minimized -> hidden popup %p\n", hwnd);
    ShowWindow( hwnd, SW_HIDE );
    flush_events( TRUE );
    GetWindowRect( hwnd, &rect );
    ok(EqualRect(&rect, &minmaxed), "rect %s\n", wine_dbgstr_rect(&rect));
    ok(0, "hidden -> minimize popup %p\n", hwnd);
    ShowWindow( hwnd, SW_MINIMIZE );
    flush_events( TRUE );
    GetWindowRect( hwnd, &rect );
    ok(EqualRect(&rect, &minmaxed), "rect %s\n", wine_dbgstr_rect(&rect));
    ok(0, "minimize -> normal (maximized) popup %p\n", hwnd);
    ShowWindow( hwnd, SW_RESTORE );
    flush_events( TRUE );
    GetWindowRect( hwnd, &rect );
    ok(EqualRect(&rect, &maximized), "rect %s\n", wine_dbgstr_rect(&rect));

    ok(0, "normal (maximized) -> normal popup %p\n", hwnd);
    ShowWindow( hwnd, SW_RESTORE );
    flush_events( TRUE );
    GetWindowRect( hwnd, &rect );
    ok(EqualRect(&rect, &expect), "rect %s\n", wine_dbgstr_rect(&rect));

    ok(0, "normal -> maximized popup %p\n", hwnd);
    ShowWindow( hwnd, SW_MAXIMIZE );
    flush_events( TRUE );
    GetWindowRect( hwnd, &rect );
    ok(EqualRect(&rect, &maximized), "rect %s\n", wine_dbgstr_rect(&rect));
    ok(0, "maximized -> hidden popup %p\n", hwnd);
    ShowWindow( hwnd, SW_HIDE );
    flush_events( TRUE );
    GetWindowRect( hwnd, &rect );
    ok(EqualRect(&rect, &maximized), "rect %s\n", wine_dbgstr_rect(&rect));
    ...
    ok(0, "normal -> maximized overlapped %p\n", hwnd);
    ShowWindow( hwnd, SW_MAXIMIZE );
    flush_events( TRUE );
    GetWindowRect( hwnd, &rect );
    maximized = rect;
    ...
    ok(0, "maximized -> normal overlapped %p\n", hwnd);
    ShowWindow( hwnd, SW_RESTORE );
    flush_events( TRUE );
    GetWindowRect( hwnd, &rect );
    ok(EqualRect(&rect, &expect), "rect %s\n", wine_dbgstr_rect(&rect));
    ...
    ok(EqualRect(&rect, &expect), "rect %s\n", wine_dbgstr_rect(&rect));
    ok(0, "normal -> minimized overlapped %p\n", hwnd);
    ShowWindow( hwnd, SW_MINIMIZE );
    flush_events( TRUE );
    GetWindowRect( hwnd, &rect );
    ok(EqualRect(&rect, &minimized), "rect %s\n", wine_dbgstr_rect(&rect));
    ok(0, "minimized -> maximized overlapped %p\n", hwnd);
    ShowWindow( hwnd, SW_MAXIMIZE );
    flush_events( TRUE );
    GetWindowRect( hwnd, &rect );
    ok(EqualRect(&rect, &maximized), "rect %s\n", wine_dbgstr_rect(&rect));
    ...
    GetWindowRect( hwnd, &rect );
    ok(EqualRect(&rect, &expect), "rect %s\n", wine_dbgstr_rect(&rect));
    ok(0, "hidden -> maximized overlapped %p\n", hwnd);
    ShowWindow( hwnd, SW_MAXIMIZE );
    flush_events( TRUE );
    GetWindowRect( hwnd, &rect );
    ok(EqualRect(&rect, &maximized), "rect %s\n", wine_dbgstr_rect(&rect));
    ok(0, "maximized -> minimized overlapped %p\n", hwnd);
    ShowWindow( hwnd, SW_MINIMIZE );
    flush_events( TRUE );
    GetWindowRect( hwnd, &rect );
    ok(EqualRect(&rect, &minmaxed), "rect %s\n", wine_dbgstr_rect(&rect));
    ok(0, "minimized -> hidden overlapped %p\n", hwnd);
    ShowWindow( hwnd, SW_HIDE );
    flush_events( TRUE );
    GetWindowRect( hwnd, &rect );
    ok(EqualRect(&rect, &minmaxed), "rect %s\n", wine_dbgstr_rect(&rect));
    ok(0, "hidden -> minimize overlapped %p\n", hwnd);
    ShowWindow( hwnd, SW_MINIMIZE );
    flush_events( TRUE );
    GetWindowRect( hwnd, &rect );
    ok(EqualRect(&rect, &minmaxed), "rect %s\n", wine_dbgstr_rect(&rect));
    ok(0, "minimize -> normal (maximized) overlapped %p\n", hwnd);
    ShowWindow( hwnd, SW_RESTORE );
    flush_events( TRUE );
    GetWindowRect( hwnd, &rect );
    ok(EqualRect(&rect, &maximized), "rect %s\n", wine_dbgstr_rect(&rect));
    ...
    GetWindowRect( hwnd, &rect );
    ok(EqualRect(&rect, &maximized), "rect %s\n", wine_dbgstr_rect(&rect));
    ok(0, "maximized -> hidden overlapped %p\n", hwnd);
    ShowWindow( hwnd, SW_HIDE );
    flush_events( TRUE );
    GetWindowRect( hwnd, &rect );
    ok(EqualRect(&rect, &maximized), "rect %s\n", wine_dbgstr_rect(&rect));
