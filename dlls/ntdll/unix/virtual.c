                                   ...
                                   pe_image_info_t *image_info, UNICODE_STRING *nt_name, BOOL is_builtin )
{
    ...
    status = map_image_into_view( view, nt_name, unix_fd, base, image_info,
                                         ...
                                         USHORT machine )
{
    ...
    if (image_info)
    {
        ...
        res = load_builtin( image_info, &nt_name, machine, addr_ptr, size_ptr, limit );
                             ...
                             ULONG_PTR limit, USHORT machine )
{
    ...
    *size = 0;
    ...
    /* check if we can replace that mapping with the builtin */
    status = load_builtin( image_info, &nt_name, machine, module, size, limit );
