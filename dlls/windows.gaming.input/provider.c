...
WIDL_impl_IWineGameControllerProvider( provider,
...
WIDL_impl_IWineGameControllerProviderVtbl( provider );
...
WIDL_impl_IGameControllerProviderVtbl( provider_IGameControllerProvider );
WIDL_impl_IAgileObjectVtbl( provider_IAgileObject );
