 ...
 * properly loaded.
 */
void zink_stub_TrimCommandPoolKHR(void);
void zink_stub_GetDescriptorSetLayoutSupportKHR(void);
void zink_stub_GetDeviceBufferMemoryRequirementsKHR(void);
void zink_stub_GetDeviceImageMemoryRequirementsKHR(void);
void zink_stub_GetDeviceImageSparseMemoryRequirementsKHR(void);
void zink_stub_CmdBindIndexBuffer2KHR(void);
void zink_stub_GetRenderingAreaGranularityKHR(void);
void zink_stub_GetDeviceImageSubresourceLayoutKHR(void);
void zink_stub_GetImageSubresourceLayout2KHR(void);
void zink_stub_CmdBindDescriptorSets2KHR(void);
void zink_stub_CmdPushConstants2KHR(void);
void zink_stub_CmdPushDescriptorSet2KHR(void);
void zink_stub_CmdPushDescriptorSetWithTemplate2KHR(void);
void zink_stub_CmdSetDescriptorBufferOffsets2EXT(void);
void zink_stub_CmdBindDescriptorBufferEmbeddedSamplers2EXT(void);
void zink_stub_GetMemoryFdKHR(void);
void zink_stub_GetMemoryFdPropertiesKHR(void);
void zink_stub_GetPipelineExecutablePropertiesKHR(void);
void zink_stub_GetPipelineExecutableStatisticsKHR(void);
void zink_stub_GetPipelineExecutableInternalRepresentationsKHR(void);
void zink_stub_ImportSemaphoreFdKHR(void);
void zink_stub_GetSemaphoreFdKHR(void);
void zink_stub_CreateRenderPass2KHR(void);
void zink_stub_CmdBeginRenderPass2KHR(void);
void zink_stub_CmdNextSubpass2KHR(void);
void zink_stub_CmdEndRenderPass2KHR(void);
void zink_stub_CmdSetEvent2KHR(void);
void zink_stub_CmdResetEvent2KHR(void);
void zink_stub_CmdWaitEvents2KHR(void);
void zink_stub_CmdPipelineBarrier2KHR(void);
void zink_stub_CmdWriteTimestamp2KHR(void);
void zink_stub_QueueSubmit2KHR(void);
void zink_stub_CmdWriteBufferMarker2AMD(void);
void zink_stub_GetQueueCheckpointData2NV(void);
void zink_stub_GetMemoryWin32HandleKHR(void);
void zink_stub_GetMemoryWin32HandlePropertiesKHR(void);
void zink_stub_ImportSemaphoreWin32HandleKHR(void);
void zink_stub_GetSemaphoreWin32HandleKHR(void);
void zink_stub_GetBufferDeviceAddressKHR(void);
void zink_stub_GetBufferOpaqueCaptureAddressKHR(void);
void zink_stub_GetDeviceMemoryOpaqueCaptureAddressKHR(void);
void zink_stub_GetMemoryHostPointerPropertiesEXT(void);
void zink_stub_GetImageMemoryRequirements2KHR(void);
void zink_stub_GetBufferMemoryRequirements2KHR(void);
void zink_stub_GetImageSparseMemoryRequirements2KHR(void);
void zink_stub_SetDeviceMemoryPriorityEXT(void);
void zink_stub_CmdDrawIndirectCountKHR(void);
void zink_stub_CmdDrawIndexedIndirectCountKHR(void);
void zink_stub_CreateShadersEXT(void);
void zink_stub_DestroyShaderEXT(void);
void zink_stub_GetShaderBinaryDataEXT(void);
void zink_stub_CmdBindShadersEXT(void);
void zink_stub_CmdSetCullModeEXT(void);
void zink_stub_CmdSetFrontFaceEXT(void);
void zink_stub_CmdSetPrimitiveTopologyEXT(void);
void zink_stub_CmdSetViewportWithCountEXT(void);
void zink_stub_CmdSetScissorWithCountEXT(void);
void zink_stub_CmdBindVertexBuffers2EXT(void);
void zink_stub_CmdSetDepthTestEnableEXT(void);
void zink_stub_CmdSetDepthWriteEnableEXT(void);
void zink_stub_CmdSetDepthCompareOpEXT(void);
void zink_stub_CmdSetDepthBoundsTestEnableEXT(void);
void zink_stub_CmdSetStencilTestEnableEXT(void);
void zink_stub_CmdSetStencilOpEXT(void);
void zink_stub_CmdSetVertexInputEXT(void);
void zink_stub_CmdSetPatchControlPointsEXT(void);
void zink_stub_CmdSetRasterizerDiscardEnableEXT(void);
void zink_stub_CmdSetDepthBiasEnableEXT(void);
void zink_stub_CmdSetLogicOpEXT(void);
void zink_stub_CmdSetPrimitiveRestartEnableEXT(void);
void zink_stub_CmdSetTessellationDomainOriginEXT(void);
void zink_stub_CmdSetDepthClampEnableEXT(void);
void zink_stub_CmdSetPolygonModeEXT(void);
void zink_stub_CmdSetRasterizationSamplesEXT(void);
void zink_stub_CmdSetSampleMaskEXT(void);
void zink_stub_CmdSetAlphaToCoverageEnableEXT(void);
void zink_stub_CmdSetAlphaToOneEnableEXT(void);
void zink_stub_CmdSetLogicOpEnableEXT(void);
void zink_stub_CmdSetColorBlendEnableEXT(void);
void zink_stub_CmdSetColorBlendEquationEXT(void);
void zink_stub_CmdSetColorWriteMaskEXT(void);
void zink_stub_CmdSetRasterizationStreamEXT(void);
void zink_stub_CmdSetConservativeRasterizationModeEXT(void);
void zink_stub_CmdSetExtraPrimitiveOverestimationSizeEXT(void);
void zink_stub_CmdSetDepthClipEnableEXT(void);
void zink_stub_CmdSetSampleLocationsEnableEXT(void);
void zink_stub_CmdSetColorBlendAdvancedEXT(void);
void zink_stub_CmdSetProvokingVertexModeEXT(void);
void zink_stub_CmdSetLineRasterizationModeEXT(void);
void zink_stub_CmdSetLineStippleEnableEXT(void);
void zink_stub_CmdSetDepthClipNegativeOneToOneEXT(void);
void zink_stub_CmdSetViewportWScalingEnableNV(void);
void zink_stub_CmdSetViewportSwizzleNV(void);
void zink_stub_CmdSetCoverageToColorEnableNV(void);
void zink_stub_CmdSetCoverageToColorLocationNV(void);
void zink_stub_CmdSetCoverageModulationModeNV(void);
void zink_stub_CmdSetCoverageModulationTableEnableNV(void);
void zink_stub_CmdSetCoverageModulationTableNV(void);
void zink_stub_CmdSetShadingRateImageEnableNV(void);
void zink_stub_CmdSetRepresentativeFragmentTestEnableNV(void);
void zink_stub_CmdSetCoverageReductionModeNV(void);
void zink_stub_CmdSetAttachmentFeedbackLoopEnableEXT(void);
void zink_stub_GetGeneratedCommandsMemoryRequirementsNV(void);
void zink_stub_CmdPreprocessGeneratedCommandsNV(void);
void zink_stub_CmdExecuteGeneratedCommandsNV(void);
void zink_stub_CmdBindPipelineShaderGroupNV(void);
void zink_stub_CreateIndirectCommandsLayoutNV(void);
void zink_stub_DestroyIndirectCommandsLayoutNV(void);
void zink_stub_CmdSetSampleLocationsEXT(void);
void zink_stub_GetDescriptorSetLayoutSizeEXT(void);
void zink_stub_GetDescriptorSetLayoutBindingOffsetEXT(void);
void zink_stub_GetDescriptorEXT(void);
void zink_stub_CmdBindDescriptorBuffersEXT(void);
void zink_stub_CmdSetDescriptorBufferOffsetsEXT(void);
void zink_stub_CmdBindDescriptorBufferEmbeddedSamplersEXT(void);
void zink_stub_GetBufferOpaqueCaptureDescriptorDataEXT(void);
void zink_stub_GetImageOpaqueCaptureDescriptorDataEXT(void);
void zink_stub_GetImageViewOpaqueCaptureDescriptorDataEXT(void);
void zink_stub_GetSamplerOpaqueCaptureDescriptorDataEXT(void);
void zink_stub_GetAccelerationStructureOpaqueCaptureDescriptorDataEXT(void);
void zink_stub_CmdBeginConditionalRenderingEXT(void);
void zink_stub_CmdEndConditionalRenderingEXT(void);
void zink_stub_CmdBindTransformFeedbackBuffersEXT(void);
void zink_stub_CmdBeginTransformFeedbackEXT(void);
void zink_stub_CmdEndTransformFeedbackEXT(void);
void zink_stub_CmdBeginQueryIndexedEXT(void);
void zink_stub_CmdEndQueryIndexedEXT(void);
void zink_stub_CmdDrawIndirectByteCountEXT(void);
void zink_stub_CreateSamplerYcbcrConversionKHR(void);
void zink_stub_DestroySamplerYcbcrConversionKHR(void);
void zink_stub_GetImageDrmFormatModifierPropertiesEXT(void);
void zink_stub_GetCalibratedTimestampsEXT(void);
void zink_stub_CmdBeginRenderingKHR(void);
void zink_stub_CmdEndRenderingKHR(void);
void zink_stub_CmdSetRenderingAttachmentLocationsKHR(void);
void zink_stub_CmdSetRenderingInputAttachmentIndicesKHR(void);
void zink_stub_CmdSetCullModeEXT(void);
void zink_stub_CmdSetFrontFaceEXT(void);
void zink_stub_CmdSetPrimitiveTopologyEXT(void);
void zink_stub_CmdSetViewportWithCountEXT(void);
...
void zink_stub_CmdSetRepresentativeFragmentTestEnableNV(void);
void zink_stub_CmdSetCoverageReductionModeNV(void);
void zink_stub_GetSemaphoreCounterValueKHR(void);
void zink_stub_WaitSemaphoresKHR(void);
void zink_stub_SignalSemaphoreKHR(void);
void zink_stub_CmdSetColorWriteEnableEXT(void);
void zink_stub_CopyMemoryToImageEXT(void);
void zink_stub_CopyImageToMemoryEXT(void);
void zink_stub_CopyImageToImageEXT(void);
void zink_stub_TransitionImageLayoutEXT(void);
void zink_stub_GetImageSubresourceLayout2EXT(void);
void zink_stub_CreateSwapchainKHR(void);
void zink_stub_DestroySwapchainKHR(void);
void zink_stub_GetSwapchainImagesKHR(void);
void zink_stub_AcquireNextImageKHR(void);
void zink_stub_QueuePresentKHR(void);
void zink_stub_GetDeviceGroupPresentCapabilitiesKHR(void);
void zink_stub_GetDeviceGroupSurfacePresentModesKHR(void);
void zink_stub_AcquireNextImage2KHR(void);
void zink_stub_CmdDrawMultiEXT(void);
void zink_stub_CmdDrawMultiIndexedEXT(void);
void zink_stub_CmdPushDescriptorSetKHR(void);
void zink_stub_CmdPushDescriptorSetWithTemplateKHR(void);
void zink_stub_CmdPushDescriptorSetWithTemplateKHR(void);
void zink_stub_CreateDescriptorUpdateTemplateKHR(void);
void zink_stub_DestroyDescriptorUpdateTemplateKHR(void);
void zink_stub_UpdateDescriptorSetWithTemplateKHR(void);
void zink_stub_CmdPushDescriptorSetWithTemplateKHR(void);
void zink_stub_CmdSetLineStippleEXT(void);
void zink_stub_CmdSetVertexInputEXT(void);
