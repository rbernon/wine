...
tr_util_pipe_cap_name(enum pipe_cap value)
{
   switch (value) {
      ...
      case PIPE_CAP_FP16: return "PIPE_CAP_FP16";
      ...
      case PIPE_CAP_CL_GL_SHARING: return "PIPE_CAP_CL_GL_SHARING";
      ...
      case PIPE_CAP_PERFORMANCE_MONITOR: return "PIPE_CAP_PERFORMANCE_MONITOR";
      case PIPE_CAP_TEXTURE_SAMPLER_INDEPENDENT: return "PIPE_CAP_TEXTURE_SAMPLER_INDEPENDENT";
