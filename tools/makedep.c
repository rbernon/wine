                                    ...
                                    unsigned int arch )
{
    ...
    else if (is_cxx)
    {
        ...
        strarray_addall( &arch_cflags, make->extlib ? extra_cxxflags_extlib[arch] : extra_cxxflags[arch] );
        strarray_addall( &arch_cflags, get_expanded_make_var_array( make, "EXTRACXXFLAGS" ) );
    }
    else
    {
