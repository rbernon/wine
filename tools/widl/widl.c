...
static void write_dlldata_list( struct strarray filenames, int define_proxy_delegation)
{
    ...
    if (!(dlldata = fopen( dlldata_name, "w" ))) error( "Could not open %s for output\n", dlldata_name );

    init_output_buffer();
    put_line( "/*** Autogenerated by WIDL %s - Do not edit ***/", PACKAGE_VERSION );
    put_line( "" );
    if (define_proxy_delegation)
        put_line( "#define PROXY_DELEGATION" );
    ...
    for (i = 0; i < filenames.count; i++)
        put_line( "EXTERN_PROXY_FILE(%s)", filenames.str[i] );

    put_line( "" );
    put_line( "PROXYFILE_LIST_START" );
    put_line( "/* Start of list */" );
    for (i = 0; i < filenames.count; i++)
        put_line( "  REFERENCE_PROXY_FILE(%s),", filenames.str[i] );
    put_line( "/* End of list */" );
    put_line( "PROXYFILE_LIST_END" );
    put_line( "" );

    put_line( "DLLDATA_ROUTINES(aProxyFileList, GET_DLL_CLSID)" );
    put_line( "" );
    put_line( "#ifdef __cplusplus" );
    put_line( "}" /* extern \"C\" */ );
    put_line( "#endif" );
    ...
    fputs( (char *)output_buffer, dlldata );
    free( output_buffer );
    fclose( dlldata );
}
...
static void write_id_data( const struct idl_ctx *ctx )
{
    ...
    init_output_buffer();
    put_line( "/*** Autogenerated by WIDL %s from %s - Do not edit ***/\n", PACKAGE_VERSION, input_idl_name );
    put_line( "#include <rpc.h>" );
    put_line( "#include <rpcndr.h>" );
    put_line( "" );
    put_line( "#ifdef _MIDL_USE_GUIDDEF_" );
    put_line( "" );
    put_line( "#ifndef INITGUID" );
    put_line( "#define INITGUID" );
    put_line( "#include <guiddef.h>" );
    put_line( "#undef INITGUID" );
    put_line( "#else" );
    put_line( "#include <guiddef.h>" );
    put_line( "#endif" );
    put_line( "" );
    put_line( "#define MIDL_DEFINE_GUID(type,name,l,w1,w2,b1,b2,b3,b4,b5,b6,b7,b8) \\" );
    put_line( "    DEFINE_GUID(name,l,w1,w2,b1,b2,b3,b4,b5,b6,b7,b8)" );
    put_line( "" );
    put_line( "#elif defined(__cplusplus)" );
    put_line( "" );
    put_line( "#define MIDL_DEFINE_GUID(type,name,l,w1,w2,b1,b2,b3,b4,b5,b6,b7,b8) \\" );
    put_line( "    EXTERN_C const type DECLSPEC_SELECTANY name = {l,w1,w2,{b1,b2,b3,b4,b5,b6,b7,b8}}" );
    put_line( "" );
    put_line( "#else" );
    put_line( "" );
    put_line( "#define MIDL_DEFINE_GUID(type,name,l,w1,w2,b1,b2,b3,b4,b5,b6,b7,b8) \\" );
    put_line( "    const type DECLSPEC_SELECTANY name = {l,w1,w2,{b1,b2,b3,b4,b5,b6,b7,b8}}" );
    put_line( "" );
    put_line( "#endif" );
    put_line( "" );
    put_line( "#ifdef __cplusplus" );
    ...
    put_line( "#endif" );
    put_line( "" );
    put_line( "#undef MIDL_DEFINE_GUID"  );
