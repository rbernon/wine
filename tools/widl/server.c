...
void write_server( const statement_list_t *stmts )
{
    ...
    proc_format_string = format_proc_format_string(stmts, need_stub, &proc_format_string_size);
    ...
    write_formatstringsdecl(server, indent, stmts, need_stub, proc_format_string_size);
    ...
    print_server( "    0,\n");
    print_server( "    {\n");
    print_server( "%s", proc_format_string );
    print_server( "        0x0\n");
    print_server( "    }\n");
    print_server( "};\n");
    print_server( "\n");
