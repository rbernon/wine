...
static void append_namespace( struct strbuf *str, struct namespace *namespace,
...
static void append_namespaces( struct strbuf *str, struct namespace *namespace, const char *prefix,
