...
#define __WINE_DBG_LOG(...) \
   wine_dbg_log( __dbcl, __dbch, __FILE__, __LINE__, __func__, \
...
extern const char * __wine_dbg_cdecl wine_dbg_vsprintf( const char *format, va_list args ) __WINE_PRINTF_ATTR(1,0) DECLSPEC_HIDDEN;
...
extern int __wine_dbg_cdecl wine_dbg_vlog( enum __wine_debug_class cls, struct __wine_debug_channel *channel,
                                           ...
                                           const char *format, va_list args ) __WINE_PRINTF_ATTR(7,0) DECLSPEC_HIDDEN;
extern int __wine_dbg_cdecl wine_dbg_log( enum __wine_debug_class cls, struct __wine_debug_channel *channel,
                                          const char *file, int line, const char *func, void *retaddr,
                                          const char *format, ... ) __WINE_PRINTF_ATTR(7,8) DECLSPEC_HIDDEN;
...
extern const char *wine_dbgstr_guid( const GUID *id ) DECLSPEC_HIDDEN;
extern const char *wine_dbgstr_point( const POINT *pt ) DECLSPEC_HIDDEN;
extern const char *wine_dbgstr_rect( const RECT *rect ) DECLSPEC_HIDDEN;
extern const char *wine_dbgstr_longlong( ULONGLONG ll ) DECLSPEC_HIDDEN;

#if defined(__oaidl_h__) && defined(V_VT)

extern const char *wine_dbgstr_vt( VARTYPE vt ) DECLSPEC_HIDDEN;
extern const char *wine_dbgstr_variant( const VARIANT *v ) DECLSPEC_HIDDEN;
