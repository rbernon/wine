...
void* __cdecl operator new[](size_t size, std::align_val_t align);
void __cdecl operator delete(void* ptr, std::align_val_t align) throw();
void __cdecl operator delete[](void* ptr, std::align_val_t align) throw();
void __cdecl operator delete(void* ptr, size_t size, std::align_val_t align) throw();
void __cdecl operator delete[](void* ptr, size_t size, std::align_val_t align) throw();
...
void* __cdecl operator new[](size_t size, std::align_val_t align, std::nothrow_t const&) throw();
void __cdecl operator delete(void* ptr, std::align_val_t align, std::nothrow_t const&) throw();
void __cdecl operator delete[](void* ptr, std::align_val_t align, std::nothrow_t const&) throw();
